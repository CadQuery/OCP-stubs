...
class StepShape_AngleRelator():
    ...
    def name(self) -> str:
        ...
        :type: str
        """
    StepShape_Equal: OCP.StepShape.StepShape_AngleRelator # value = StepShape_AngleRelator.StepShape_Equal
    StepShape_Large: OCP.StepShape.StepShape_AngleRelator # value = StepShape_AngleRelator.StepShape_Large
    StepShape_Small: OCP.StepShape.StepShape_AngleRelator # value = StepShape_AngleRelator.StepShape_Small
    __entries: dict # value = {'StepShape_Equal': (StepShape_AngleRelator.StepShape_Equal, None), 'StepShape_Large': (StepShape_AngleRelator.StepShape_Large, None), 'StepShape_Small': (StepShape_AngleRelator.StepShape_Small, None)}
    __members__: dict # value = {'StepShape_Equal': StepShape_AngleRelator.StepShape_Equal, 'StepShape_Large': StepShape_AngleRelator.StepShape_Large, 'StepShape_Small': StepShape_AngleRelator.StepShape_Small}
    pass
...
class StepShape_BooleanOperator():
    ...
    def name(self) -> str:
        ...
        :type: str
        """
    StepShape_boDifference: OCP.StepShape.StepShape_BooleanOperator # value = StepShape_BooleanOperator.StepShape_boDifference
    StepShape_boIntersection: OCP.StepShape.StepShape_BooleanOperator # value = StepShape_BooleanOperator.StepShape_boIntersection
    StepShape_boUnion: OCP.StepShape.StepShape_BooleanOperator # value = StepShape_BooleanOperator.StepShape_boUnion
    __entries: dict # value = {'StepShape_boDifference': (StepShape_BooleanOperator.StepShape_boDifference, None), 'StepShape_boIntersection': (StepShape_BooleanOperator.StepShape_boIntersection, None), 'StepShape_boUnion': (StepShape_BooleanOperator.StepShape_boUnion, None)}
    __members__: dict # value = {'StepShape_boDifference': StepShape_BooleanOperator.StepShape_boDifference, 'StepShape_boIntersection': StepShape_BooleanOperator.StepShape_boIntersection, 'StepShape_boUnion': StepShape_BooleanOperator.StepShape_boUnion}
    pass
