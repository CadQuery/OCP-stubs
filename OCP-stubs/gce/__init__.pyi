...
class gce_ErrorType():
    ...
    def name(self) -> str:
        ...
        :type: str
        """
    __entries: dict # value = {'gce_Done': (gce_ErrorType.gce_Done, None), 'gce_ConfusedPoints': (gce_ErrorType.gce_ConfusedPoints, None), 'gce_NegativeRadius': (gce_ErrorType.gce_NegativeRadius, None), 'gce_ColinearPoints': (gce_ErrorType.gce_ColinearPoints, None), 'gce_IntersectionError': (gce_ErrorType.gce_IntersectionError, None), 'gce_NullAxis': (gce_ErrorType.gce_NullAxis, None), 'gce_NullAngle': (gce_ErrorType.gce_NullAngle, None), 'gce_NullRadius': (gce_ErrorType.gce_NullRadius, None), 'gce_InvertAxis': (gce_ErrorType.gce_InvertAxis, None), 'gce_BadAngle': (gce_ErrorType.gce_BadAngle, None), 'gce_InvertRadius': (gce_ErrorType.gce_InvertRadius, None), 'gce_NullFocusLength': (gce_ErrorType.gce_NullFocusLength, None), 'gce_NullVector': (gce_ErrorType.gce_NullVector, None), 'gce_BadEquation': (gce_ErrorType.gce_BadEquation, None)}
    __members__: dict # value = {'gce_Done': gce_ErrorType.gce_Done, 'gce_ConfusedPoints': gce_ErrorType.gce_ConfusedPoints, 'gce_NegativeRadius': gce_ErrorType.gce_NegativeRadius, 'gce_ColinearPoints': gce_ErrorType.gce_ColinearPoints, 'gce_IntersectionError': gce_ErrorType.gce_IntersectionError, 'gce_NullAxis': gce_ErrorType.gce_NullAxis, 'gce_NullAngle': gce_ErrorType.gce_NullAngle, 'gce_NullRadius': gce_ErrorType.gce_NullRadius, 'gce_InvertAxis': gce_ErrorType.gce_InvertAxis, 'gce_BadAngle': gce_ErrorType.gce_BadAngle, 'gce_InvertRadius': gce_ErrorType.gce_InvertRadius, 'gce_NullFocusLength': gce_ErrorType.gce_NullFocusLength, 'gce_NullVector': gce_ErrorType.gce_NullVector, 'gce_BadEquation': gce_ErrorType.gce_BadEquation}
    gce_BadAngle: OCP.gce.gce_ErrorType # value = gce_ErrorType.gce_BadAngle
    gce_BadEquation: OCP.gce.gce_ErrorType # value = gce_ErrorType.gce_BadEquation
    gce_ColinearPoints: OCP.gce.gce_ErrorType # value = gce_ErrorType.gce_ColinearPoints
    gce_ConfusedPoints: OCP.gce.gce_ErrorType # value = gce_ErrorType.gce_ConfusedPoints
    gce_Done: OCP.gce.gce_ErrorType # value = gce_ErrorType.gce_Done
    gce_IntersectionError: OCP.gce.gce_ErrorType # value = gce_ErrorType.gce_IntersectionError
    gce_InvertAxis: OCP.gce.gce_ErrorType # value = gce_ErrorType.gce_InvertAxis
    gce_InvertRadius: OCP.gce.gce_ErrorType # value = gce_ErrorType.gce_InvertRadius
    gce_NegativeRadius: OCP.gce.gce_ErrorType # value = gce_ErrorType.gce_NegativeRadius
    gce_NullAngle: OCP.gce.gce_ErrorType # value = gce_ErrorType.gce_NullAngle
    gce_NullAxis: OCP.gce.gce_ErrorType # value = gce_ErrorType.gce_NullAxis
    gce_NullFocusLength: OCP.gce.gce_ErrorType # value = gce_ErrorType.gce_NullFocusLength
    gce_NullRadius: OCP.gce.gce_ErrorType # value = gce_ErrorType.gce_NullRadius
    gce_NullVector: OCP.gce.gce_ErrorType # value = gce_ErrorType.gce_NullVector
    pass
class gce_Root():
    """
