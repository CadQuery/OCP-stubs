...
class Approx_Array1OfAdHSurface:
    ...
    def Assign(self, theOther: Approx_Array1OfAdHSurface) -> Approx_Array1OfAdHSurface:
        ...
        """
    def ChangeFirst(self) -> OCP.Adaptor3d.Adaptor3d_HSurface:
        """
        Returns first element
        """
    def ChangeLast(self) -> OCP.Adaptor3d.Adaptor3d_HSurface:
        """
        Returns last element
        """
    def ChangeValue(self, theIndex: int) -> OCP.Adaptor3d.Adaptor3d_HSurface:
        """
        Variable value access
        """
    def First(self) -> OCP.Adaptor3d.Adaptor3d_HSurface:
        """
        Returns first element
        """
    def Init(self, theValue: OCP.Adaptor3d.Adaptor3d_HSurface) -> None:
        """
    ...
    def IsEmpty(self) -> bool:
        ...
        """
    def Last(self) -> OCP.Adaptor3d.Adaptor3d_HSurface:
        """
        Returns last element
        """
    def Length(self) -> int:
    ...
    def Resize(self, theLower: int, theUpper: int, theToCopyData: bool) -> None:
        ...
        """
    def SetValue(
        self, theIndex: int, theItem: OCP.Adaptor3d.Adaptor3d_HSurface
    ) -> None:
        """
        Set value
        """
    ...
    def Upper(self) -> int:
        ...
        Upper bound
        """
    def Value(self, theIndex: int) -> OCP.Adaptor3d.Adaptor3d_HSurface:
        """
        Constant value access
        """
    @overload
    def __init__(
        self, theBegin: OCP.Adaptor3d.Adaptor3d_HSurface, theLower: int, theUpper: int
    ) -> None: ...
    @overload
...
class Approx_Array1OfGTrsf2d:
    ...
    @overload
    def __init__(
        self, theBegin: OCP.gp.gp_GTrsf2d, theLower: int, theUpper: int
    ) -> None: ...
    @overload
    def __init__(self) -> None: ...
    @overload
...
class Approx_Curve2d:
    ...
    def __init__(
        self,
        C2D: OCP.Adaptor2d.Adaptor2d_HCurve2d,
        First: float,
        Last: float,
        TolU: float,
        TolV: float,
...
class Approx_Curve3d:
    ...
    def __init__(
        self,
        Curve: OCP.Adaptor3d.Adaptor3d_HCurve,
        Tol3d: float,
        Order: OCP.GeomAbs.GeomAbs_Shape,
        MaxSegments: int,
        MaxDegree: int,
    ) -> None: ...
    pass
...
class Approx_CurvilinearParameter:
    ...
    def __init__(
        self,
        C2D1: OCP.Adaptor2d.Adaptor2d_HCurve2d,
        Surf1: OCP.Adaptor3d.Adaptor3d_HSurface,
        C2D2: OCP.Adaptor2d.Adaptor2d_HCurve2d,
        Surf2: OCP.Adaptor3d.Adaptor3d_HSurface,
        Tol: float,
        Order: OCP.GeomAbs.GeomAbs_Shape,
        MaxDegree: int,
        MaxSegments: int,
...
class Approx_CurvlinFunc(OCP.Standard.Standard_Transient):
    """
    defines an abstract curve with curvilinear parametrizationdefines an abstract curve with curvilinear parametrizationdefines an abstract curve with curvilinear parametrization
    """
    ...
    def DynamicType(self) -> OCP.Standard.Standard_Type:
        ...
        """
    def EvalCase1(
        self, S: float, Order: int, Result: OCP.TColStd.TColStd_Array1OfReal
    ) -> bool:
        """
        if myCase != 1
        """
    ...
    def GetSParameter(self, U: float) -> float:
        ...
        """
    def GetUParameter(
        self, C: OCP.Adaptor3d.Adaptor3d_Curve, S: float, NumberOfCurve: int
    ) -> float:
        """
    ...
    def IncrementRefCounter(self) -> None:
        ...
        """
    def Intervals(
        self, T: OCP.TColStd.TColStd_Array1OfReal, S: OCP.GeomAbs.GeomAbs_Shape
    ) -> None:
        """
    ...
    @overload
    def Length(
        self, C: OCP.Adaptor3d.Adaptor3d_Curve, FirstU: float, LasrU: float
    ) -> float: ...
    ...
    @overload
    def __init__(self, C: OCP.Adaptor3d.Adaptor3d_HCurve, Tol: float) -> None: ...
    @overload
    def __init__(
        self,
        C2D1: OCP.Adaptor2d.Adaptor2d_HCurve2d,
...
class Approx_FitAndDivide:
    ...
    def __init__(
        self,
        Line: OCP.AppCont.AppCont_Function,
        degreemin: int = 3,
        degreemax: int = 8,
        Tolerance3d: float = 1e-05,
        Tolerance2d: float = 1e-05,
        cutting: bool = False,
        FirstC: OCP.AppParCurves.AppParCurves_Constraint = AppParCurves_Constraint.AppParCurves_TangencyPoint,
        LastC: OCP.AppParCurves.AppParCurves_Constraint = AppParCurves_Constraint.AppParCurves_TangencyPoint,
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class Approx_HArray1OfAdHSurface(
    Approx_Array1OfAdHSurface, OCP.Standard.Standard_Transient
):
    ...
    @overload
    def __init__(
        self, theLower: int, theUpper: int, theValue: OCP.Adaptor3d.Adaptor3d_HSurface
    ) -> None: ...
    @overload
    def __init__(self) -> None: ...
    @overload
...
class Approx_HArray1OfGTrsf2d(Approx_Array1OfGTrsf2d, OCP.Standard.Standard_Transient):
    ...
    @overload
    def __init__(
        self, theLower: int, theUpper: int, theValue: OCP.gp.gp_GTrsf2d
    ) -> None: ...
    @overload
    def __init__(self, theOther: Approx_Array1OfGTrsf2d) -> None: ...
    @overload
...
class Approx_MCurvesToBSpCurve:
    ...
    @overload
    def Perform(
        self, TheSeq: OCP.AppParCurves.AppParCurves_SequenceOfMultiCurve
    ) -> None: ...
    def Reset(self) -> None:
        """
        None
...
class Approx_SequenceOfHArray1OfReal(OCP.NCollection.NCollection_BaseSequence):
    ...
    def Assign(
        self, theOther: Approx_SequenceOfHArray1OfReal
    ) -> Approx_SequenceOfHArray1OfReal:
        """
    ...
    @overload
    def InsertAfter(
        self, theIndex: int, theItem: OCP.TColStd.TColStd_HArray1OfReal
    ) -> None:
        """
    ...
    @overload
    def InsertAfter(
        self, theIndex: int, theSeq: Approx_SequenceOfHArray1OfReal
    ) -> None: ...
    @overload
    def InsertBefore(
        self, theIndex: int, theItem: OCP.TColStd.TColStd_HArray1OfReal
    ...
    @staticmethod
    def delNode_s(
        theNode: NCollection_SeqNode, theAl: OCP.NCollection.NCollection_BaseAllocator
    ) -> None:
        """
...
class Approx_SweepApproximation:
    ...
    def Curve2d(
        self,
        Index: int,
        TPoles: OCP.TColgp.TColgp_Array1OfPnt2d,
        TKnots: OCP.TColStd.TColStd_Array1OfReal,
        TMults: OCP.TColStd.TColStd_Array1OfInteger,
    ) -> None:
        """
        None
        """
    ...
    def Perform(
        ...
        Tol2d: float,
        TolAngular: float,
        Continuity: OCP.GeomAbs.GeomAbs_Shape = GeomAbs_Shape.GeomAbs_C0,
        Degmax: int = 11,
        Segmax: int = 50,
    ) -> None:
        """
    ...
    def Surface(
        self,
        TPoles: OCP.TColgp.TColgp_Array2OfPnt,
        TWeights: OCP.TColStd.TColStd_Array2OfReal,
        TUKnots: OCP.TColStd.TColStd_Array1OfReal,
        TVKnots: OCP.TColStd.TColStd_Array1OfReal,
        TUMults: OCP.TColStd.TColStd_Array1OfInteger,
        TVMults: OCP.TColStd.TColStd_Array1OfInteger,
    ) -> None:
        """
        None
        """
...
class Approx_SweepFunction(OCP.Standard.Standard_Transient):
    ...
    def D0(
        ...
        First: float,
        Last: float,
        Poles: OCP.TColgp.TColgp_Array1OfPnt,
        Poles2d: OCP.TColgp.TColgp_Array1OfPnt2d,
        Weigths: OCP.TColStd.TColStd_Array1OfReal,
    ) -> bool:
        """
    ...
    def D1(
        ...
        Last: float,
        Poles: OCP.TColgp.TColgp_Array1OfPnt,
        DPoles: OCP.TColgp.TColgp_Array1OfVec,
        Poles2d: OCP.TColgp.TColgp_Array1OfPnt2d,
        DPoles2d: OCP.TColgp.TColgp_Array1OfVec2d,
        Weigths: OCP.TColStd.TColStd_Array1OfReal,
        DWeigths: OCP.TColStd.TColStd_Array1OfReal,
    ) -> bool:
        """
    ...
    def D2(
        ...
        Poles: OCP.TColgp.TColgp_Array1OfPnt,
        DPoles: OCP.TColgp.TColgp_Array1OfVec,
        D2Poles: OCP.TColgp.TColgp_Array1OfVec,
        Poles2d: OCP.TColgp.TColgp_Array1OfPnt2d,
        DPoles2d: OCP.TColgp.TColgp_Array1OfVec2d,
        D2Poles2d: OCP.TColgp.TColgp_Array1OfVec2d,
        Weigths: OCP.TColStd.TColStd_Array1OfReal,
        DWeigths: OCP.TColStd.TColStd_Array1OfReal,
        D2Weigths: OCP.TColStd.TColStd_Array1OfReal,
    ) -> bool:
        """
    ...
    def GetTolerance(
        ...
        SurfTol: float,
        AngleTol: float,
        Tol3d: OCP.TColStd.TColStd_Array1OfReal,
    ) -> None:
        """
