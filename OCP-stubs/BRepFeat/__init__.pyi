...
class BRepFeat():
    ...
    def ParametricMinMax_s(S : OCP.TopoDS.TopoDS_Shape,C : OCP.Geom.Geom_Curve,Ori : bool=False) -> Tuple[float, float, float, float, bool]: 
        ...
        """
    @staticmethod
    def Print_s(SE : BRepFeat_StatusError,S : Any) -> Any: 
        """
...
class BRepFeat_PerfSelection():
    ...
    def name(self) -> str:
        ...
        :type: str
        """
    BRepFeat_NoSelection: OCP.BRepFeat.BRepFeat_PerfSelection # value = BRepFeat_PerfSelection.BRepFeat_NoSelection
    BRepFeat_SelectionFU: OCP.BRepFeat.BRepFeat_PerfSelection # value = BRepFeat_PerfSelection.BRepFeat_SelectionFU
    BRepFeat_SelectionSh: OCP.BRepFeat.BRepFeat_PerfSelection # value = BRepFeat_PerfSelection.BRepFeat_SelectionSh
    BRepFeat_SelectionShU: OCP.BRepFeat.BRepFeat_PerfSelection # value = BRepFeat_PerfSelection.BRepFeat_SelectionShU
    BRepFeat_SelectionU: OCP.BRepFeat.BRepFeat_PerfSelection # value = BRepFeat_PerfSelection.BRepFeat_SelectionU
    __entries: dict # value = {'BRepFeat_NoSelection': (BRepFeat_PerfSelection.BRepFeat_NoSelection, None), 'BRepFeat_SelectionFU': (BRepFeat_PerfSelection.BRepFeat_SelectionFU, None), 'BRepFeat_SelectionU': (BRepFeat_PerfSelection.BRepFeat_SelectionU, None), 'BRepFeat_SelectionSh': (BRepFeat_PerfSelection.BRepFeat_SelectionSh, None), 'BRepFeat_SelectionShU': (BRepFeat_PerfSelection.BRepFeat_SelectionShU, None)}
...
class BRepFeat_Status():
    ...
    def name(self) -> str:
        ...
        :type: str
        """
    BRepFeat_HoleTooLong: OCP.BRepFeat.BRepFeat_Status # value = BRepFeat_Status.BRepFeat_HoleTooLong
    BRepFeat_InvalidPlacement: OCP.BRepFeat.BRepFeat_Status # value = BRepFeat_Status.BRepFeat_InvalidPlacement
    BRepFeat_NoError: OCP.BRepFeat.BRepFeat_Status # value = BRepFeat_Status.BRepFeat_NoError
    __entries: dict # value = {'BRepFeat_NoError': (BRepFeat_Status.BRepFeat_NoError, None), 'BRepFeat_InvalidPlacement': (BRepFeat_Status.BRepFeat_InvalidPlacement, None), 'BRepFeat_HoleTooLong': (BRepFeat_Status.BRepFeat_HoleTooLong, None)}
    __members__: dict # value = {'BRepFeat_NoError': BRepFeat_Status.BRepFeat_NoError, 'BRepFeat_InvalidPlacement': BRepFeat_Status.BRepFeat_InvalidPlacement, 'BRepFeat_HoleTooLong': BRepFeat_Status.BRepFeat_HoleTooLong}
    pass
class BRepFeat_StatusError():
    ...
    def name(self) -> str:
        ...
        :type: str
        """
    BRepFeat_BadDirect: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_BadDirect
    BRepFeat_BadIntersect: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_BadIntersect
    BRepFeat_EmptyBaryCurve: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_EmptyBaryCurve
    BRepFeat_EmptyCutResult: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_EmptyCutResult
    BRepFeat_FalseSide: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_FalseSide
    BRepFeat_IncDirection: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_IncDirection
    BRepFeat_IncParameter: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_IncParameter
    BRepFeat_IncSlidFace: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_IncSlidFace
    BRepFeat_IncTypes: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_IncTypes
    BRepFeat_IntervalOverlap: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_IntervalOverlap
    BRepFeat_InvFirstShape: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_InvFirstShape
    BRepFeat_InvOption: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_InvOption
    BRepFeat_InvShape: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_InvShape
    BRepFeat_LocOpeInvNotDone: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_LocOpeInvNotDone
    BRepFeat_LocOpeNotDone: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_LocOpeNotDone
    BRepFeat_NoExtFace: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_NoExtFace
    BRepFeat_NoFaceProf: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_NoFaceProf
    BRepFeat_NoGluer: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_NoGluer
    BRepFeat_NoIntersectF: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_NoIntersectF
    BRepFeat_NoIntersectU: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_NoIntersectU
    BRepFeat_NoParts: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_NoParts
    BRepFeat_NoProjPt: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_NoProjPt
    BRepFeat_NotInitialized: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_NotInitialized
    BRepFeat_NotYetImplemented: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_NotYetImplemented
    BRepFeat_NullRealTool: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_NullRealTool
    BRepFeat_NullToolF: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_NullToolF
    BRepFeat_NullToolU: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_NullToolU
    BRepFeat_OK: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_OK
    __entries: dict # value = {'BRepFeat_OK': (BRepFeat_StatusError.BRepFeat_OK, None), 'BRepFeat_BadDirect': (BRepFeat_StatusError.BRepFeat_BadDirect, None), 'BRepFeat_BadIntersect': (BRepFeat_StatusError.BRepFeat_BadIntersect, None), 'BRepFeat_EmptyBaryCurve': (BRepFeat_StatusError.BRepFeat_EmptyBaryCurve, None), 'BRepFeat_EmptyCutResult': (BRepFeat_StatusError.BRepFeat_EmptyCutResult, None), 'BRepFeat_FalseSide': (BRepFeat_StatusError.BRepFeat_FalseSide, None), 'BRepFeat_IncDirection': (BRepFeat_StatusError.BRepFeat_IncDirection, None), 'BRepFeat_IncSlidFace': (BRepFeat_StatusError.BRepFeat_IncSlidFace, None), 'BRepFeat_IncParameter': (BRepFeat_StatusError.BRepFeat_IncParameter, None), 'BRepFeat_IncTypes': (BRepFeat_StatusError.BRepFeat_IncTypes, None), 'BRepFeat_IntervalOverlap': (BRepFeat_StatusError.BRepFeat_IntervalOverlap, None), 'BRepFeat_InvFirstShape': (BRepFeat_StatusError.BRepFeat_InvFirstShape, None), 'BRepFeat_InvOption': (BRepFeat_StatusError.BRepFeat_InvOption, None), 'BRepFeat_InvShape': (BRepFeat_StatusError.BRepFeat_InvShape, None), 'BRepFeat_LocOpeNotDone': (BRepFeat_StatusError.BRepFeat_LocOpeNotDone, None), 'BRepFeat_LocOpeInvNotDone': (BRepFeat_StatusError.BRepFeat_LocOpeInvNotDone, None), 'BRepFeat_NoExtFace': (BRepFeat_StatusError.BRepFeat_NoExtFace, None), 'BRepFeat_NoFaceProf': (BRepFeat_StatusError.BRepFeat_NoFaceProf, None), 'BRepFeat_NoGluer': (BRepFeat_StatusError.BRepFeat_NoGluer, None), 'BRepFeat_NoIntersectF': (BRepFeat_StatusError.BRepFeat_NoIntersectF, None), 'BRepFeat_NoIntersectU': (BRepFeat_StatusError.BRepFeat_NoIntersectU, None), 'BRepFeat_NoParts': (BRepFeat_StatusError.BRepFeat_NoParts, None), 'BRepFeat_NoProjPt': (BRepFeat_StatusError.BRepFeat_NoProjPt, None), 'BRepFeat_NotInitialized': (BRepFeat_StatusError.BRepFeat_NotInitialized, None), 'BRepFeat_NotYetImplemented': (BRepFeat_StatusError.BRepFeat_NotYetImplemented, None), 'BRepFeat_NullRealTool': (BRepFeat_StatusError.BRepFeat_NullRealTool, None), 'BRepFeat_NullToolF': (BRepFeat_StatusError.BRepFeat_NullToolF, None), 'BRepFeat_NullToolU': (BRepFeat_StatusError.BRepFeat_NullToolU, None)}
    __members__: dict # value = {'BRepFeat_OK': BRepFeat_StatusError.BRepFeat_OK, 'BRepFeat_BadDirect': BRepFeat_StatusError.BRepFeat_BadDirect, 'BRepFeat_BadIntersect': BRepFeat_StatusError.BRepFeat_BadIntersect, 'BRepFeat_EmptyBaryCurve': BRepFeat_StatusError.BRepFeat_EmptyBaryCurve, 'BRepFeat_EmptyCutResult': BRepFeat_StatusError.BRepFeat_EmptyCutResult, 'BRepFeat_FalseSide': BRepFeat_StatusError.BRepFeat_FalseSide, 'BRepFeat_IncDirection': BRepFeat_StatusError.BRepFeat_IncDirection, 'BRepFeat_IncSlidFace': BRepFeat_StatusError.BRepFeat_IncSlidFace, 'BRepFeat_IncParameter': BRepFeat_StatusError.BRepFeat_IncParameter, 'BRepFeat_IncTypes': BRepFeat_StatusError.BRepFeat_IncTypes, 'BRepFeat_IntervalOverlap': BRepFeat_StatusError.BRepFeat_IntervalOverlap, 'BRepFeat_InvFirstShape': BRepFeat_StatusError.BRepFeat_InvFirstShape, 'BRepFeat_InvOption': BRepFeat_StatusError.BRepFeat_InvOption, 'BRepFeat_InvShape': BRepFeat_StatusError.BRepFeat_InvShape, 'BRepFeat_LocOpeNotDone': BRepFeat_StatusError.BRepFeat_LocOpeNotDone, 'BRepFeat_LocOpeInvNotDone': BRepFeat_StatusError.BRepFeat_LocOpeInvNotDone, 'BRepFeat_NoExtFace': BRepFeat_StatusError.BRepFeat_NoExtFace, 'BRepFeat_NoFaceProf': BRepFeat_StatusError.BRepFeat_NoFaceProf, 'BRepFeat_NoGluer': BRepFeat_StatusError.BRepFeat_NoGluer, 'BRepFeat_NoIntersectF': BRepFeat_StatusError.BRepFeat_NoIntersectF, 'BRepFeat_NoIntersectU': BRepFeat_StatusError.BRepFeat_NoIntersectU, 'BRepFeat_NoParts': BRepFeat_StatusError.BRepFeat_NoParts, 'BRepFeat_NoProjPt': BRepFeat_StatusError.BRepFeat_NoProjPt, 'BRepFeat_NotInitialized': BRepFeat_StatusError.BRepFeat_NotInitialized, 'BRepFeat_NotYetImplemented': BRepFeat_StatusError.BRepFeat_NotYetImplemented, 'BRepFeat_NullRealTool': BRepFeat_StatusError.BRepFeat_NullRealTool, 'BRepFeat_NullToolF': BRepFeat_StatusError.BRepFeat_NullToolF, 'BRepFeat_NullToolU': BRepFeat_StatusError.BRepFeat_NullToolU}
    pass
BRepFeat_BadDirect: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_BadDirect
BRepFeat_BadIntersect: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_BadIntersect
BRepFeat_EmptyBaryCurve: OCP.BRepFeat.BRepFeat_StatusError # value = BRepFeat_StatusError.BRepFeat_EmptyBaryCurve
