...
class AdvApprox_ApproxAFunction:
    ...
    def Approximation_s(
        TotalDimension: int,
        TotalNumSS: int,
        LocalDimension: OCP.TColStd.TColStd_Array1OfInteger,
        First: float,
        Last: float,
        ...
        NumMaxCoeffs: int,
        MaxSegments: int,
        TolerancesArray: OCP.TColStd.TColStd_Array1OfReal,
        code_precis: int,
        NumCoeffPerCurveArray: OCP.TColStd.TColStd_Array1OfInteger,
        LocalCoefficientArray: OCP.TColStd.TColStd_Array1OfReal,
        IntervalsArray: OCP.TColStd.TColStd_Array1OfReal,
        ErrorMaxArray: OCP.TColStd.TColStd_Array1OfReal,
        AverageErrorArray: OCP.TColStd.TColStd_Array1OfReal,
    ) -> Tuple[int, int]:
        """
        None
        """
...
class AdvApprox_PrefAndRec(AdvApprox_Cutting):
    ...
    def __init__(
        self,
        RecomendedCut: OCP.TColStd.TColStd_Array1OfReal,
        PrefferedCut: OCP.TColStd.TColStd_Array1OfReal,
        Weight: float = 5.0,
    ) -> None: ...
    pass
...
class AdvApprox_SimpleApprox:
    ...
    def Perform(
        self,
        LocalDimension: OCP.TColStd.TColStd_Array1OfInteger,
        LocalTolerancesArray: OCP.TColStd.TColStd_Array1OfReal,
        First: float,
        Last: float,
        MaxDegree: int,
    ) -> None:
    ...
    def __init__(
        ...
        WorkDegree: int,
        NbGaussPoints: int,
        JacobiBase: OCP.PLib.PLib_JacobiPolynomial,
        Func: AdvApprox_EvaluatorFunction,
    ) -> None: ...
    pass
