...
class BRepBuilderAPI_Collect:
    ...
    def Add(self, SI: OCP.TopoDS.TopoDS_Shape, MKS: BRepBuilderAPI_MakeShape) -> None:
        ...
        """
    def AddGenerated(
        self, S: OCP.TopoDS.TopoDS_Shape, Gen: OCP.TopoDS.TopoDS_Shape
    ) -> None:
        """
        None
        """
    def AddModif(
        self, S: OCP.TopoDS.TopoDS_Shape, Mod: OCP.TopoDS.TopoDS_Shape
    ) -> None:
        """
        None
        """
...
class BRepBuilderAPI_Copy(
    BRepBuilderAPI_ModifyShape, BRepBuilderAPI_MakeShape, BRepBuilderAPI_Command
):
    """
    ...
    def ModifiedShape(self, S: OCP.TopoDS.TopoDS_Shape) -> OCP.TopoDS.TopoDS_Shape:
        ...
        """
    def Perform(
        self, S: OCP.TopoDS.TopoDS_Shape, copyGeom: bool = True, copyMesh: bool = False
    ) -> None:
        """
...
class BRepBuilderAPI_GTransform(
    ...
    @overload
    def __init__(
        self, S: OCP.TopoDS.TopoDS_Shape, T: OCP.gp.gp_GTrsf, Copy: bool = False
    ) -> None: ...
    @overload
...
class BRepBuilderAPI_Sewing(OCP.Standard.Standard_Transient):
    ...
    def ModifiedSubShape(
        self, shape: OCP.TopoDS.TopoDS_Shape
    ...
    def Tolerance(self) -> float:
        ...
        """
    def WhichFace(
        self, theEdg: OCP.TopoDS.TopoDS_Edge, index: int = 1
...
class BRepBuilderAPI_Transform(
    ...
    @overload
    def __init__(
        self, S: OCP.TopoDS.TopoDS_Shape, T: OCP.gp.gp_Trsf, Copy: bool = False
    ) -> None: ...
    @overload
...
class BRepBuilderAPI_VertexInspector(
    OCP.NCollection.NCollection_CellFilter_InspectorXYZ
):
    """
