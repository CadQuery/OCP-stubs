...
class BRepAdaptor_Array1OfCurve:
    ...
    @overload
    def __init__(
        self, theBegin: BRepAdaptor_Curve, theLower: int, theUpper: int
    ) -> None: ...
    @overload
...
class BRepAdaptor_CompCurve(OCP.Adaptor3d.Adaptor3d_Curve):
    ...
    def D1(self, U: float, P: OCP.gp.gp_Pnt, V: OCP.gp.gp_Vec) -> None:
        ...
        """
    def D2(
        self, U: float, P: OCP.gp.gp_Pnt, V1: OCP.gp.gp_Vec, V2: OCP.gp.gp_Vec
    ) -> None:
        """
    ...
    @overload
    def Initialize(
        self, W: OCP.TopoDS.TopoDS_Wire, KnotByCurvilinearAbcissa: bool
    ) -> None:
        """
        Sets the wire <W>.
    ...
    def Resolution(self, R3d: float) -> float:
        ...
        """
    def Trim(
        self, First: float, Last: float, Tol: float
    ...
    @overload
    def __init__(
        self, W: OCP.TopoDS.TopoDS_Wire, KnotByCurvilinearAbcissa: bool = False
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class BRepAdaptor_Curve(OCP.Adaptor3d.Adaptor3d_Curve):
    ...
    @overload
    def Initialize(
        self, E: OCP.TopoDS.TopoDS_Edge, F: OCP.TopoDS.TopoDS_Face
    ) -> None: ...
    def Intervals(
        self, T: OCP.TColStd.TColStd_Array1OfReal, S: OCP.GeomAbs.GeomAbs_Shape
    ) -> None:
...
class BRepAdaptor_Curve2d(
    OCP.Geom2dAdaptor.Geom2dAdaptor_Curve, OCP.Adaptor2d.Adaptor2d_Curve2d
):
    """
    ...
    def D1(self, U: float, P: OCP.gp.gp_Pnt2d, V: OCP.gp.gp_Vec2d) -> None:
        ...
        """
    def D2(
        self, U: float, P: OCP.gp.gp_Pnt2d, V1: OCP.gp.gp_Vec2d, V2: OCP.gp.gp_Vec2d
    ) -> None:
        """
        Returns the point P of parameter U, the first and second derivatives V1 and V2. Raised if the continuity of the current interval is not C2.
        """
    ...
    def Trim(
        self, First: float, Last: float, Tol: float
    ) -> OCP.Adaptor2d.Adaptor2d_HCurve2d:
        """
        Returns a curve equivalent of <me> between parameters <First> and <Last>. <Tol> is used to test for 3d points confusion. If <First> >= <Last>
        """
...
class BRepAdaptor_HArray1OfCurve(
    BRepAdaptor_Array1OfCurve, OCP.Standard.Standard_Transient
):
    ...
    @overload
    def __init__(
        self, theLower: int, theUpper: int, theValue: BRepAdaptor_Curve
    ) -> None: ...
    def __iter__(self) -> iterator: ...
    @staticmethod
...
class BRepAdaptor_HCompCurve(
    OCP.Adaptor3d.Adaptor3d_HCurve, OCP.Standard.Standard_Transient
):
    def BSpline(self) -> OCP.Geom.Geom_BSplineCurve:
        """
        None
...
class BRepAdaptor_HCurve2d(
    OCP.Adaptor2d.Adaptor2d_HCurve2d, OCP.Standard.Standard_Transient
):
    def BSpline(self) -> OCP.Geom2d.Geom2d_BSplineCurve:
        """
        None
...
class BRepAdaptor_HSurface(
    OCP.Adaptor3d.Adaptor3d_HSurface, OCP.Standard.Standard_Transient
):
