...
class Aspect_AspectFillAreaDefinitionError(Exception, BaseException):
    class type:
        ...
        class type:
            pass
        @staticmethod
        def __instancecheck__() -> bool: ...
        @staticmethod
        def __prepare__() -> dict: ...
        @staticmethod
        def __subclasscheck__() -> bool: ...
        @staticmethod
        def __subclasses__() -> Any: ...
        @staticmethod
        def mro() -> list: ...
...
class Aspect_Grid(OCP.Standard.Standard_Transient):
    ...
    def Colors(
        self,
        aColor: OCP.Quantity.Quantity_Color,
        aTenthColor: OCP.Quantity.Quantity_Color,
    ) -> None:
        """
...
class Aspect_DisplayConnection(OCP.Standard.Standard_Transient):
    ...
    @overload
    def __init__(
        self, theDisplayName: OCP.TCollection.TCollection_AsciiString
    ) -> None: ...
    @staticmethod
    def get_type_descriptor_s() -> OCP.Standard.Standard_Type:
        """
...
class Aspect_GradientBackground(Aspect_Background):
    ...
    def Color(self) -> OCP.Quantity.Quantity_Color:
        ...
        """
    def Colors(
        self, AColor1: OCP.Quantity.Quantity_Color, AColor2: OCP.Quantity.Quantity_Color
    ) -> None:
        """
    ...
    def SetColors(
        self,
        AColor1: OCP.Quantity.Quantity_Color,
        AColor2: OCP.Quantity.Quantity_Color,
        AMethod: Aspect_GradientFillMethod = Aspect_GradientFillMethod.Aspect_GFM_HOR,
    ) -> None:
        """
...
class Aspect_Window(OCP.Standard.Standard_Transient):
    ...
    def SetBackground(
        self,
        theFirstColor: OCP.Quantity.Quantity_Color,
        theSecondColor: OCP.Quantity.Quantity_Color,
...
class Aspect_RectangularGrid(Aspect_Grid, OCP.Standard.Standard_Transient):
    ...
    def __init__(
        ...
        anXOrigin: float = 0.0,
        anYOrigin: float = 0.0,
        aFirstAngle: float = 0.0,
        aSecondAngle: float = 0.0,
        aRotationAngle: float = 0.0,
    ) -> None: ...
    @staticmethod
    def get_type_descriptor_s() -> OCP.Standard.Standard_Type:
...
class Aspect_ScrollDelta:
    ...
    @overload
    def __init__(
        self, thePnt: OCP.Graphic3d.Graphic3d_Vec2i, theValue: float, theFlags: int = 0
    ) -> None: ...
    @overload
    def __init__(self) -> None: ...
    @overload
...
class Aspect_SequenceOfColor(OCP.NCollection.NCollection_BaseSequence):
    ...
    @overload
    def InsertBefore(
        self, theIndex: int, theItem: OCP.Quantity.Quantity_Color
    ) -> None: ...
...
class Aspect_Touch:
    ...
    @overload
    def __init__(
        self, thePnt: OCP.Graphic3d.Graphic3d_Vec2d, theIsPreciseDevice: bool
    ) -> None: ...
    @overload
