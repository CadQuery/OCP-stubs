...
class BRep_Builder(OCP.TopoDS.TopoDS_Builder):
    ...
    def Continuity(
        self,
        E: OCP.TopoDS.TopoDS_Edge,
        S1: OCP.Geom.Geom_Surface,
        S2: OCP.Geom.Geom_Surface,
        L1: OCP.TopLoc.TopLoc_Location,
        L2: OCP.TopLoc.TopLoc_Location,
        C: OCP.GeomAbs.GeomAbs_Shape,
    ) -> None: ...
    ...
    @overload
    def MakeEdge(
        self, E: OCP.TopoDS.TopoDS_Edge, C: OCP.Geom.Geom_Curve, Tol: float
    ) -> None:
        """
    ...
    def MakeEdge(
        self,
        E: OCP.TopoDS.TopoDS_Edge,
        N: OCP.Poly.Poly_PolygonOnTriangulation,
        T: OCP.Poly.Poly_Triangulation,
        L: OCP.TopLoc.TopLoc_Location,
    ) -> None: ...
    @overload
    def MakeEdge(
        self, E: OCP.TopoDS.TopoDS_Edge, P: OCP.Poly.Poly_Polygon3D
    ) -> None: ...
    @overload
    def MakeEdge(
        self,
    ...
    @overload
    def MakeFace(
        self, F: OCP.TopoDS.TopoDS_Face, S: OCP.Geom.Geom_Surface, Tol: float
    ) -> None: ...
    @overload
    def MakeFace(
        self,
    ...
    @overload
    def Range(
        self, E: OCP.TopoDS.TopoDS_Edge, First: float, Last: float, Only3d: bool = False
    ) -> None: ...
    @overload
    def Range(
        self,
    ...
    def Transfert(
        self,
        Ein: OCP.TopoDS.TopoDS_Edge,
        Eout: OCP.TopoDS.TopoDS_Edge,
        Vin: OCP.TopoDS.TopoDS_Vertex,
        Vout: OCP.TopoDS.TopoDS_Vertex,
    ) -> None:
        """
    ...
    @overload
    def Transfert(
        self, Ein: OCP.TopoDS.TopoDS_Edge, Eout: OCP.TopoDS.TopoDS_Edge
    ) -> None: ...
    @overload
    ...
    def UpdateEdge(
        self,
        E: OCP.TopoDS.TopoDS_Edge,
        C1: OCP.Geom2d.Geom2d_Curve,
        C2: OCP.Geom2d.Geom2d_Curve,
        S: OCP.Geom.Geom_Surface,
        L: OCP.TopLoc.TopLoc_Location,
        Tol: float,
        Pf: OCP.gp.gp_Pnt2d,
    ...
    def UpdateEdge(
        self,
        E: OCP.TopoDS.TopoDS_Edge,
        P1: OCP.Poly.Poly_Polygon2D,
        P2: OCP.Poly.Poly_Polygon2D,
        S: OCP.Geom.Geom_Surface,
        L: OCP.TopLoc.TopLoc_Location,
    ) -> None: ...
    @overload
    def UpdateEdge(
        self,
        E: OCP.TopoDS.TopoDS_Edge,
        P: OCP.Poly.Poly_Polygon2D,
        S: OCP.TopoDS.TopoDS_Face,
    ) -> None: ...
    @overload
    def UpdateEdge(
        self,
    ...
    def UpdateEdge(
        self,
        E: OCP.TopoDS.TopoDS_Edge,
        P1: OCP.Poly.Poly_PolygonOnTriangulation,
        P2: OCP.Poly.Poly_PolygonOnTriangulation,
        T: OCP.Poly.Poly_Triangulation,
    ) -> None: ...
    @overload
    def UpdateEdge(
    ...
    def UpdateEdge(
        self,
        E: OCP.TopoDS.TopoDS_Edge,
        N1: OCP.Poly.Poly_PolygonOnTriangulation,
        N2: OCP.Poly.Poly_PolygonOnTriangulation,
        T: OCP.Poly.Poly_Triangulation,
        L: OCP.TopLoc.TopLoc_Location,
    ) -> None: ...
    @overload
...
class BRep_CurveRepresentation(OCP.Standard.Standard_Transient):
    ...
    def IsCurveOnSurface(
        self, S: OCP.Geom.Geom_Surface, L: OCP.TopLoc.TopLoc_Location
    ) -> bool:
        """
    ...
    def IsPolygonOnTriangulation(
        self, T: OCP.Poly.Poly_Triangulation, L: OCP.TopLoc.TopLoc_Location
    ) -> bool:
        """
...
class BRep_CurveOnSurface(
    BRep_GCurve, BRep_CurveRepresentation, OCP.Standard.Standard_Transient
):
    """
...
class BRep_Curve3D(
    ...
    def Update(self) -> None:
        ...
        """
    def __init__(
        self, C: OCP.Geom.Geom_Curve, L: OCP.TopLoc.TopLoc_Location
    ) -> None: ...
    @staticmethod
    def get_type_descriptor_s() -> OCP.Standard.Standard_Type:
        """
...
class BRep_ListOfCurveRepresentation(OCP.NCollection.NCollection_BaseList):
    ...
    def Assign(
        self, theOther: BRep_ListOfCurveRepresentation
    ) -> BRep_ListOfCurveRepresentation:
        """
    ...
    @overload
    def InsertAfter(
        self, theItem: BRep_CurveRepresentation, theIter: Any
    ) -> BRep_CurveRepresentation:
        """
        InsertAfter
    ...
    @overload
    def InsertAfter(
        self, theOther: BRep_ListOfCurveRepresentation, theIter: Any
    ) -> None: ...
    @overload
    def InsertBefore(
        self, theItem: BRep_CurveRepresentation, theIter: Any
    ...
    @overload
    def Prepend(
        self, theItem: BRep_CurveRepresentation
    ) -> BRep_CurveRepresentation: ...
...
class BRep_ListOfPointRepresentation(OCP.NCollection.NCollection_BaseList):
    ...
    def Assign(
        self, theOther: BRep_ListOfPointRepresentation
    ) -> BRep_ListOfPointRepresentation:
        """
        Replace this list by the items of another list (theOther parameter). This method does not change the internal allocator.
        """
    ...
    @overload
    def InsertAfter(
        self, theOther: BRep_ListOfPointRepresentation, theIter: Any
    ) -> None:
        """
        InsertAfter
    ...
    @overload
    def InsertAfter(
        self, theItem: BRep_PointRepresentation, theIter: Any
    ) -> BRep_PointRepresentation: ...
    @overload
    def InsertBefore(
        self, theOther: BRep_ListOfPointRepresentation, theIter: Any
...
class BRep_PointOnSurface(
    BRep_PointsOnSurface, BRep_PointRepresentation, OCP.Standard.Standard_Transient
):
    """
...
class BRep_PointOnCurve(BRep_PointRepresentation, OCP.Standard.Standard_Transient):
    ...
    def This(self) -> OCP.Standard.Standard_Transient:
        ...
        """
    def __init__(
        self, P: float, C: OCP.Geom.Geom_Curve, L: OCP.TopLoc.TopLoc_Location
    ) -> None: ...
    @staticmethod
    def get_type_descriptor_s() -> OCP.Standard.Standard_Type:
        """
...
class BRep_Polygon3D(BRep_CurveRepresentation, OCP.Standard.Standard_Transient):
    ...
    def Triangulation(self) -> OCP.Poly.Poly_Triangulation:
        ...
        """
    def __init__(
        self, P: OCP.Poly.Poly_Polygon3D, L: OCP.TopLoc.TopLoc_Location
    ) -> None: ...
    @staticmethod
    def get_type_descriptor_s() -> OCP.Standard.Standard_Type:
        """
...
class BRep_PolygonOnTriangulation(
    BRep_CurveRepresentation, OCP.Standard.Standard_Transient
):
    """
...
class BRep_PolygonOnClosedSurface(
    BRep_PolygonOnSurface, BRep_CurveRepresentation, OCP.Standard.Standard_Transient
):
    """
...
class BRep_PolygonOnClosedTriangulation(
    ...
    def PolygonOnTriangulation2(
        self, P2: OCP.Poly.Poly_PolygonOnTriangulation
    ) -> None: ...
    def Surface(self) -> OCP.Geom.Geom_Surface:
        """
        None
    ...
    def __init__(
        ...
        P1: OCP.Poly.Poly_PolygonOnTriangulation,
        P2: OCP.Poly.Poly_PolygonOnTriangulation,
        Tr: OCP.Poly.Poly_Triangulation,
        L: OCP.TopLoc.TopLoc_Location,
    ) -> None: ...
    @staticmethod
    def get_type_descriptor_s() -> OCP.Standard.Standard_Type:
...
class BRep_TEdge(
    OCP.TopoDS.TopoDS_TEdge, OCP.TopoDS.TopoDS_TShape, OCP.Standard.Standard_Transient
):
    """
...
class BRep_TFace(
    OCP.TopoDS.TopoDS_TFace, OCP.TopoDS.TopoDS_TShape, OCP.Standard.Standard_Transient
):
    """
...
class BRep_TVertex(
    OCP.TopoDS.TopoDS_TVertex, OCP.TopoDS.TopoDS_TShape, OCP.Standard.Standard_Transient
):
    """
...
class BRep_Tool:
    ...
    @overload
    def Curve_s(
        E: OCP.TopoDS.TopoDS_Edge, First: float, Last: float
    ) -> OCP.Geom.Geom_Curve: ...
    @staticmethod
    ...
    @staticmethod
    def MaxTolerance_s(
        theShape: OCP.TopoDS.TopoDS_Shape, theSubShape: OCP.TopAbs.TopAbs_ShapeEnum
    ) -> float:
        """
        None
        """
    ...
    @staticmethod
    def Parameters_s(
        V: OCP.TopoDS.TopoDS_Vertex, F: OCP.TopoDS.TopoDS_Face
    ) -> OCP.gp.gp_Pnt2d:
        """
    ...
    @staticmethod
    def Polygon3D_s(
        E: OCP.TopoDS.TopoDS_Edge, L: OCP.TopLoc.TopLoc_Location
    ) -> OCP.Poly.Poly_Polygon3D:
        """
        Returns the 3D polygon of the edge. May be a Null handle. Returns in <L> the location for the polygon.
        """
    @staticmethod
    @overload
    def PolygonOnSurface_s(
        E: OCP.TopoDS.TopoDS_Edge,
        S: OCP.Geom.Geom_Surface,
        L: OCP.TopLoc.TopLoc_Location,
    ) -> OCP.Poly.Poly_Polygon2D:
        """
    ...
    @staticmethod
    @overload
    def PolygonOnTriangulation_s(
        E: OCP.TopoDS.TopoDS_Edge,
        T: OCP.Poly.Poly_Triangulation,
        L: OCP.TopLoc.TopLoc_Location,
    ) -> OCP.Poly.Poly_PolygonOnTriangulation:
        """
        Returns the polygon associated to the edge in the parametric space of the face. Returns a NULL handle if this polygon does not exist.
    ...
    def SetUVPoints_s(
        ...
        S: OCP.Geom.Geom_Surface,
        L: OCP.TopLoc.TopLoc_Location,
        PFirst: OCP.gp.gp_Pnt2d,
        PLast: OCP.gp.gp_Pnt2d,
    ) -> None:
        """
    ...
    @overload
    def Surface_s(
        F: OCP.TopoDS.TopoDS_Face, L: OCP.TopLoc.TopLoc_Location
