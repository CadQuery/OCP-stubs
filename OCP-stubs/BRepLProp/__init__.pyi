...
class BRepLProp:
    ...
    @overload
    def Continuity_s(
        C1: OCP.BRepAdaptor.BRepAdaptor_Curve,
        C2: OCP.BRepAdaptor.BRepAdaptor_Curve,
        u1: float,
        u2: float,
        tl: float,
        ta: float,
...
class BRepLProp_CLProps:
    ...
    @overload
    def __init__(
        self, C: OCP.BRepAdaptor.BRepAdaptor_Curve, N: int, Resolution: float
    ) -> None: ...
    @overload
    def __init__(
        self, C: OCP.BRepAdaptor.BRepAdaptor_Curve, U: float, N: int, Resolution: float
    ) -> None: ...
    pass
...
class BRepLProp_CurveTool:
    ...
    @staticmethod
    def D1_s(
        C: OCP.BRepAdaptor.BRepAdaptor_Curve,
        U: float,
        P: OCP.gp.gp_Pnt,
        V1: OCP.gp.gp_Vec,
    ) -> None:
    ...
    @staticmethod
    def Value_s(
        C: OCP.BRepAdaptor.BRepAdaptor_Curve, U: float, P: OCP.gp.gp_Pnt
    ) -> None:
        """
...
class BRepLProp_SLProps:
    ...
    @overload
    def __init__(
        self, S: OCP.BRepAdaptor.BRepAdaptor_Surface, N: int, Resolution: float
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class BRepLProp_SurfaceTool:
    ...
    @staticmethod
    def DN_s(
        S: OCP.BRepAdaptor.BRepAdaptor_Surface, U: float, V: float, IU: int, IV: int
    ) -> OCP.gp.gp_Vec:
        """
        None
        """
