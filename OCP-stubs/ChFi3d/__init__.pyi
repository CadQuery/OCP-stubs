...
class ChFi3d:
    ...
    @staticmethod
    def ConcaveSide_s(
        S1: OCP.BRepAdaptor.BRepAdaptor_Surface,
        S2: OCP.BRepAdaptor.BRepAdaptor_Surface,
        E: OCP.TopoDS.TopoDS_Edge,
        Or1: OCP.TopAbs.TopAbs_Orientation,
        Or2: OCP.TopAbs.TopAbs_Orientation,
    ) -> int:
        """
    ...
    @overload
    def NextSide_s(
        Or: OCP.TopAbs.TopAbs_Orientation,
        OrSave: OCP.TopAbs.TopAbs_Orientation,
        OrFace: OCP.TopAbs.TopAbs_Orientation,
    ) -> None:
        """
    ...
    def NextSide_s(
        Or1: OCP.TopAbs.TopAbs_Orientation,
        Or2: OCP.TopAbs.TopAbs_Orientation,
        OrSave1: OCP.TopAbs.TopAbs_Orientation,
        OrSave2: OCP.TopAbs.TopAbs_Orientation,
        ChoixSauv: int,
    ) -> int: ...
    @staticmethod
    def SameSide_s(
        ...
        OrSave1: OCP.TopAbs.TopAbs_Orientation,
        OrSave2: OCP.TopAbs.TopAbs_Orientation,
        OrFace1: OCP.TopAbs.TopAbs_Orientation,
        OrFace2: OCP.TopAbs.TopAbs_Orientation,
    ) -> bool:
        """
...
class ChFi3d_Builder:
    ...
    def FirstVertex(self, IC: int) -> OCP.TopoDS.TopoDS_Vertex:
        ...
        """
    def Generated(
        self, EouV: OCP.TopoDS.TopoDS_Shape
    ...
    def Reset(self) -> None:
        ...
        """
    def SetContinuity(
        self, InternalContinuity: OCP.GeomAbs.GeomAbs_Shape, AngularTolerance: float
    ) -> None:
        """
        None
        """
    ...
    def SplitKPart(
        self,
        Data: OCP.ChFiDS.ChFiDS_SurfData,
        SetData: OCP.ChFiDS.ChFiDS_SequenceOfSurfData,
        Spine: OCP.ChFiDS.ChFiDS_Spine,
        Iedge: int,
        S1: OCP.Adaptor3d.Adaptor3d_HSurface,
        I1: OCP.Adaptor3d.Adaptor3d_TopolTool,
        S2: OCP.Adaptor3d.Adaptor3d_HSurface,
        I2: OCP.Adaptor3d.Adaptor3d_TopolTool,
        Intf: bool,
        Intl: bool,
    ) -> bool:
        """
...
class ChFi3d_ChBuilder(ChFi3d_Builder):
    ...
    def PerformSurf(
        self,
        Data: OCP.ChFiDS.ChFiDS_SequenceOfSurfData,
        Guide: OCP.ChFiDS.ChFiDS_HElSpine,
        Spine: OCP.ChFiDS.ChFiDS_Spine,
        Choix: int,
        S1: OCP.BRepAdaptor.BRepAdaptor_HSurface,
        I1: OCP.Adaptor3d.Adaptor3d_TopolTool,
        PC1: OCP.BRepAdaptor.BRepAdaptor_HCurve2d,
        Sref1: OCP.BRepAdaptor.BRepAdaptor_HSurface,
        PCref1: OCP.BRepAdaptor.BRepAdaptor_HCurve2d,
        Or1: OCP.TopAbs.TopAbs_Orientation,
        S2: OCP.BRepAdaptor.BRepAdaptor_HSurface,
        I2: OCP.Adaptor3d.Adaptor3d_TopolTool,
        PC2: OCP.BRepAdaptor.BRepAdaptor_HCurve2d,
        Sref2: OCP.BRepAdaptor.BRepAdaptor_HSurface,
        PCref2: OCP.BRepAdaptor.BRepAdaptor_HCurve2d,
        Or2: OCP.TopAbs.TopAbs_Orientation,
        MaxStep: float,
        Fleche: float,
        TolGuide: float,
    ...
    def SetDist(self, Dis: float, IC: int, F: OCP.TopoDS.TopoDS_Face) -> None:
        ...
        """
    def SetDistAngle(
        self, Dis: float, Angle: float, IC: int, F: OCP.TopoDS.TopoDS_Face
    ) -> None:
        """
        ...
        """
    def SetDists(
        self, Dis1: float, Dis2: float, IC: int, F: OCP.TopoDS.TopoDS_Face
    ) -> None:
        """
...
class ChFi3d_FilBuilder(ChFi3d_Builder):
    ...
    def Generated(
        ...
        """
    def GetBounds(
        self, IC: int, E: OCP.TopoDS.TopoDS_Edge, First: float, Last: float
    ) -> bool:
        """
    ...
    def SetFilletShape(self, FShape: ChFi3d_FilletShape) -> None:
        ...
        """
    def SetLaw(
        self, IC: int, E: OCP.TopoDS.TopoDS_Edge, L: OCP.Law.Law_Function
    ) -> None:
        """
    ...
    @overload
    def SetRadius(
        self, Radius: float, IC: int, V: OCP.TopoDS.TopoDS_Vertex
    ) -> None: ...
    def Shape(self) -> OCP.TopoDS.TopoDS_Shape:
        """
        if (Isdone()) makes the result. if (!Isdone())
    ...
    def __init__(
        ...
        FShape: ChFi3d_FilletShape = ChFi3d_FilletShape.ChFi3d_Rational,
        Ta: float = 0.01,
    ) -> None: ...
    pass
...
class ChFi3d_FilletShape:
    ...
    def name(self) -> str:
        ...
        :type: str
        """
    ChFi3d_Polynomial: OCP.ChFi3d.ChFi3d_FilletShape  # value = ChFi3d_FilletShape.ChFi3d_Polynomial
    ChFi3d_QuasiAngular: OCP.ChFi3d.ChFi3d_FilletShape  # value = ChFi3d_FilletShape.ChFi3d_QuasiAngular
    ChFi3d_Rational: OCP.ChFi3d.ChFi3d_FilletShape  # value = ChFi3d_FilletShape.ChFi3d_Rational
    __entries: dict  # value = {'ChFi3d_Rational': (ChFi3d_FilletShape.ChFi3d_Rational, None), 'ChFi3d_QuasiAngular': (ChFi3d_FilletShape.ChFi3d_QuasiAngular, None), 'ChFi3d_Polynomial': (ChFi3d_FilletShape.ChFi3d_Polynomial, None)}
    __members__: dict  # value = {'ChFi3d_Rational': ChFi3d_FilletShape.ChFi3d_Rational, 'ChFi3d_QuasiAngular': ChFi3d_FilletShape.ChFi3d_QuasiAngular, 'ChFi3d_Polynomial': ChFi3d_FilletShape.ChFi3d_Polynomial}
    pass
...
def ChFi3d_AngleEdge(
    Vtx: OCP.TopoDS.TopoDS_Vertex,
...
def ChFi3d_BoundFac(
    S: OCP.BRepAdaptor.BRepAdaptor_Surface,
    umin: float,
    umax: float,
    vmin: float,
    vmax: float,
    checknaturalbounds: bool = True,
) -> None:
    """
    None
    """
...
def ChFi3d_BoundSrf(
    S: OCP.GeomAdaptor.GeomAdaptor_Surface,
    umin: float,
    umax: float,
    vmin: float,
    vmax: float,
...
def ChFi3d_BoundSurf(
    DStr: OCP.TopOpeBRepDS.TopOpeBRepDS_DataStructure,
    Fd1: OCP.ChFiDS.ChFiDS_SurfData,
    IFaCo1: int,
    IFaArc1: int,
) -> OCP.GeomAdaptor.GeomAdaptor_HSurface:
    """
    None
    """

@overload
def ChFi3d_BuildPCurve(
    Surf: OCP.Adaptor3d.Adaptor3d_HSurface,
    p1: OCP.gp.gp_Pnt2d,
    v1: OCP.gp.gp_Vec2d,
    p2: OCP.gp.gp_Pnt2d,
    v2: OCP.gp.gp_Vec2d,
    redresse: bool = False,
) -> OCP.Geom2d.Geom2d_Curve:
    """
    None
...
def ChFi3d_CheckSameParameter(
    C3d: OCP.Adaptor3d.Adaptor3d_HCurve,
    Pcurv: OCP.Geom2d.Geom2d_Curve,
    S: OCP.Adaptor3d.Adaptor3d_HSurface,
    tol3d: float,
    tolreached: float,
) -> bool:
    """
...
def ChFi3d_ChercheBordsLibres(
    myVEMap: OCP.ChFiDS.ChFiDS_Map,
    V1: OCP.TopoDS.TopoDS_Vertex,
    bordlibre: bool,
    edgelibre1: OCP.TopoDS.TopoDS_Edge,
    edgelibre2: OCP.TopoDS.TopoDS_Edge,
) -> None:
    """
    None
    """

def ChFi3d_CircularSpine(
    WFirst: float,
    WLast: float,
    Pdeb: OCP.gp.gp_Pnt,
    Vdeb: OCP.gp.gp_Vec,
    ...
    Vfin: OCP.gp.gp_Vec,
    rad: float,
) -> OCP.Geom.Geom_Circle:
    """
    None
    """

def ChFi3d_Coefficient(
    V3d: OCP.gp.gp_Vec, D1u: OCP.gp.gp_Vec, D1v: OCP.gp.gp_Vec, DU: float, DV: float
) -> None:
    """
    None
    """

def ChFi3d_ComputeArete(
    P1: OCP.ChFiDS.ChFiDS_CommonPoint,
    UV1: OCP.gp.gp_Pnt2d,
    P2: OCP.ChFiDS.ChFiDS_CommonPoint,
    UV2: OCP.gp.gp_Pnt2d,
    Surf: OCP.Geom.Geom_Surface,
    C3d: OCP.Geom.Geom_Curve,
    Pcurv: OCP.Geom2d.Geom2d_Curve,
    Pardeb: float,
    Parfin: float,
    tol3d: float,
...
def ChFi3d_ComputeCurves(
    S1: OCP.Adaptor3d.Adaptor3d_HSurface,
    S2: OCP.Adaptor3d.Adaptor3d_HSurface,
    Pardeb: OCP.TColStd.TColStd_Array1OfReal,
    Parfin: OCP.TColStd.TColStd_Array1OfReal,
    C3d: OCP.Geom.Geom_Curve,
    Pc1: OCP.Geom2d.Geom2d_Curve,
    Pc2: OCP.Geom2d.Geom2d_Curve,
    tol3d: float,
    tol2d: float,
    tolreached: float,
    wholeCurv: bool = True,
...
@overload
def ChFi3d_ComputesIntPC(
    Fi1: OCP.ChFiDS.ChFiDS_FaceInterference,
    Fi2: OCP.ChFiDS.ChFiDS_FaceInterference,
    HS1: OCP.GeomAdaptor.GeomAdaptor_HSurface,
    HS2: OCP.GeomAdaptor.GeomAdaptor_HSurface,
    UInt1: float,
    UInt2: float,
) -> None:
    """
...
def ChFi3d_Couture(
    F: OCP.TopoDS.TopoDS_Face, couture: bool, edgecouture: OCP.TopoDS.TopoDS_Edge
) -> None:
    """
    None
    """

def ChFi3d_CoutureOnVertex(
    F: OCP.TopoDS.TopoDS_Face,
    V: OCP.TopoDS.TopoDS_Vertex,
    couture: bool,
    edgecouture: OCP.TopoDS.TopoDS_Edge,
) -> None:
    """
    None
    """

def ChFi3d_EdgeFromV1(
    V1: OCP.TopoDS.TopoDS_Vertex, CD: OCP.ChFiDS.ChFiDS_Stripe, sens: int
) -> OCP.TopoDS.TopoDS_Edge:
    """
    None
    """

def ChFi3d_EdgeState(
    E: OCP.TopoDS.TopoDS_Edge, EFMap: OCP.ChFiDS.ChFiDS_Map
) -> OCP.ChFiDS.ChFiDS_State:
    """
    None
    """

@overload
def ChFi3d_EnlargeBox(
    S: OCP.Adaptor3d.Adaptor3d_HSurface,
    PC: OCP.Geom2d.Geom2d_Curve,
    wd: float,
    wf: float,
    box1: OCP.Bnd.Bnd_Box,
    box2: OCP.Bnd.Bnd_Box,
) -> None:
    """
    None
...
def ChFi3d_EnlargeBox(
    E: OCP.TopoDS.TopoDS_Edge,
    LF: OCP.TopTools.TopTools_ListOfShape,
    w: float,
    box: OCP.Bnd.Bnd_Box,
) -> None:
    pass
...
def ChFi3d_EnlargeBox(
    DStr: OCP.TopOpeBRepDS.TopOpeBRepDS_DataStructure,
    st: OCP.ChFiDS.ChFiDS_Stripe,
    sd: OCP.ChFiDS.ChFiDS_SurfData,
    b1: OCP.Bnd.Bnd_Box,
    b2: OCP.Bnd.Bnd_Box,
    isfirst: bool,
) -> None:
...
def ChFi3d_ExtrSpineCarac(
    DStr: OCP.TopOpeBRepDS.TopOpeBRepDS_DataStructure,
    cd: OCP.ChFiDS.ChFiDS_Stripe,
    i: int,
    p: float,
    jf: int,
    sens: int,
...
def ChFi3d_FilCommonPoint(
    SP: OCP.BRepBlend.BRepBlend_Extremity,
    TransLine: OCP.IntSurf.IntSurf_TypeTrans,
    Start: bool,
    CP: OCP.ChFiDS.ChFiDS_CommonPoint,
    Tol: float,
) -> None:
    """
    None
...
def ChFi3d_FilCurveInDS(
    Icurv: int,
    Isurf: int,
    Pcurv: OCP.Geom2d.Geom2d_Curve,
    Et: OCP.TopAbs.TopAbs_Orientation,
) -> OCP.TopOpeBRepDS.TopOpeBRepDS_SurfaceCurveInterference:
    """
    None
    """
...
def ChFi3d_FilDS(
    SolidIndex: int,
    CorDat: OCP.ChFiDS.ChFiDS_Stripe,
    DStr: OCP.TopOpeBRepDS.TopOpeBRepDS_DataStructure,
    reglist: OCP.ChFiDS.ChFiDS_Regularities,
    tol3d: float,
    tol2d: float,
) -> None:
    """
...
def ChFi3d_FilPointInDS(
    Et: OCP.TopAbs.TopAbs_Orientation,
    Ic: int,
    Ip: int,
    Par: float,
    IsVertex: bool = False,
) -> OCP.TopOpeBRepDS.TopOpeBRepDS_CurvePointInterference:
    """
    None
    """

def ChFi3d_FilVertexInDS(
    Et: OCP.TopAbs.TopAbs_Orientation, Ic: int, Ip: int, Par: float
) -> OCP.TopOpeBRepDS.TopOpeBRepDS_CurvePointInterference:
    """
    None
    """

def ChFi3d_IndexOfSurfData(
    V1: OCP.TopoDS.TopoDS_Vertex, CD: OCP.ChFiDS.ChFiDS_Stripe, sens: int
) -> int:
    """
    None
...
def ChFi3d_IndexPointInDS(
    P1: OCP.ChFiDS.ChFiDS_CommonPoint, DStr: OCP.TopOpeBRepDS.TopOpeBRepDS_DataStructure
) -> int:
    """
    None
    """
...
def ChFi3d_IntCS(
    S: OCP.Adaptor3d.Adaptor3d_HSurface,
    C: OCP.Adaptor3d.Adaptor3d_HCurve,
    p2dS: OCP.gp.gp_Pnt2d,
    wc: float,
) -> bool:
    """
    None
...
def ChFi3d_IntTraces(
    fd1: OCP.ChFiDS.ChFiDS_SurfData,
    pref1: float,
    p1: float,
    jf1: int,
    sens1: int,
    fd2: OCP.ChFiDS.ChFiDS_SurfData,
    pref2: float,
    p2: float,
    jf2: int,
    sens2: int,
    RefP2d: OCP.gp.gp_Pnt2d,
    Check2dDistance: bool = False,
    enlarge: bool = False,
) -> bool:
    """
    None
...
def ChFi3d_InterPlaneEdge(
    Plan: OCP.Adaptor3d.Adaptor3d_HSurface,
    C: OCP.Adaptor3d.Adaptor3d_HCurve,
    W: float,
    Sens: bool,
    tolc: float,
...
def ChFi3d_IsInFront(
    DStr: OCP.TopOpeBRepDS.TopOpeBRepDS_DataStructure,
    cd1: OCP.ChFiDS.ChFiDS_Stripe,
    cd2: OCP.ChFiDS.ChFiDS_Stripe,
    i1: int,
    i2: int,
    sens1: int,
    sens2: int,
...
def ChFi3d_NbNotDegeneratedEdges(
    Vtx: OCP.TopoDS.TopoDS_Vertex, VEMap: OCP.ChFiDS.ChFiDS_Map
) -> int:
    """
    None
    """

def ChFi3d_NumberOfEdges(
    Vtx: OCP.TopoDS.TopoDS_Vertex, VEMap: OCP.ChFiDS.ChFiDS_Map
) -> int:
    """
    None
...
def ChFi3d_NumberOfSharpEdges(
    Vtx: OCP.TopoDS.TopoDS_Vertex,
    VEMap: OCP.ChFiDS.ChFiDS_Map,
    EFmap: OCP.ChFiDS.ChFiDS_Map,
) -> int:
    """
    None
    """

def ChFi3d_Parameters(
    S: OCP.Geom.Geom_Surface, p3d: OCP.gp.gp_Pnt, u: float, v: float
) -> None:
    """
    None
    """

def ChFi3d_PerformElSpine(
    HES: OCP.ChFiDS.ChFiDS_HElSpine,
    Spine: OCP.ChFiDS.ChFiDS_Spine,
    continuity: OCP.GeomAbs.GeomAbs_Shape,
    tol: float,
    IsOffset: bool = False,
) -> None:
    """
...
def ChFi3d_ProjectPCurv(
    HCg: OCP.Adaptor3d.Adaptor3d_HCurve,
    HSg: OCP.Adaptor3d.Adaptor3d_HSurface,
    Pcurv: OCP.Geom2d.Geom2d_Curve,
    tol3d: float,
    tolreached: float,
) -> None:
...
def ChFi3d_SolidIndex(
    sp: OCP.ChFiDS.ChFiDS_Spine,
    DStr: OCP.TopOpeBRepDS.TopOpeBRepDS_DataStructure,
    MapESo: OCP.ChFiDS.ChFiDS_Map,
    MapESh: OCP.ChFiDS.ChFiDS_Map,
) -> int:
    """
    None
    """
...
def ChFi3d_Spine(
    pd: OCP.gp.gp_Pnt, vd: OCP.gp.gp_Vec, pf: OCP.gp.gp_Pnt, vf: OCP.gp.gp_Vec, R: float
) -> OCP.Geom.Geom_BezierCurve:
    """
    None
    """

def ChFi3d_StripeEdgeInter(
    theStripe1: OCP.ChFiDS.ChFiDS_Stripe,
    theStripe2: OCP.ChFiDS.ChFiDS_Stripe,
    DStr: OCP.TopOpeBRepDS.TopOpeBRepDS_DataStructure,
    tol2d: float,
) -> None:
    """
...
def ChFi3d_TrimCurve(
    gc: OCP.Geom.Geom_Curve,
    FirstP: OCP.gp.gp_Pnt,
    LastP: OCP.gp.gp_Pnt,
    gtc: OCP.Geom.Geom_TrimmedCurve,
) -> None:
    """
    None
    """

def ChFi3d_TrsfTrans(
    T1: OCP.IntSurf.IntSurf_TypeTrans,
) -> OCP.TopAbs.TopAbs_Orientation:
    """
    None
    """

def ChFi3d_cherche_edge(
    V: OCP.TopoDS.TopoDS_Vertex,
    E1: OCP.TopTools.TopTools_Array1OfShape,
...
def ChFi3d_cherche_face1(
    map: OCP.TopTools.TopTools_ListOfShape,
    F1: OCP.TopoDS.TopoDS_Face,
    F: OCP.TopoDS.TopoDS_Face,
) -> None:
    """
...
def ChFi3d_cherche_vertex(
    E1: OCP.TopoDS.TopoDS_Edge,
    E2: OCP.TopoDS.TopoDS_Edge,
    vertex: OCP.TopoDS.TopoDS_Vertex,
    trouve: bool,
) -> None:
    """
    None
...
def ChFi3d_edge_common_faces(
    mapEF: OCP.TopTools.TopTools_ListOfShape,
    F1: OCP.TopoDS.TopoDS_Face,
    F2: OCP.TopoDS.TopoDS_Face,
) -> None:
    """
...
def ChFi3d_evalconti(
    E: OCP.TopoDS.TopoDS_Edge, F1: OCP.TopoDS.TopoDS_Face, F2: OCP.TopoDS.TopoDS_Face
) -> OCP.GeomAbs.GeomAbs_Shape:
    """
    None
    """

def ChFi3d_isTangentFaces(
    theEdge: OCP.TopoDS.TopoDS_Edge,
    theFace1: OCP.TopoDS.TopoDS_Face,
    theFace2: OCP.TopoDS.TopoDS_Face,
    Order: OCP.GeomAbs.GeomAbs_Shape = GeomAbs_Shape.GeomAbs_G1,
) -> bool:
    """
    None
    """
...
@overload
def ChFi3d_mkbound(
    HS: OCP.Adaptor3d.Adaptor3d_HSurface,
    curv: OCP.Geom2d.Geom2d_Curve,
    t3d: float,
    ta: float,
    isfreeboundary: bool = False,
) -> OCP.GeomFill.GeomFill_Boundary:
    """
    None
...
@overload
def ChFi3d_mkbound(
    Fac: OCP.Adaptor3d.Adaptor3d_HSurface,
    curv: OCP.Geom2d.Geom2d_Curve,
    p1: OCP.gp.gp_Pnt2d,
    p2: OCP.gp.gp_Pnt2d,
    t3d: float,
...
def ChFi3d_mkbound(
    ...
    curv: OCP.Geom2d.Geom2d_Curve,
    sens1: int,
    pfac1: OCP.gp.gp_Pnt2d,
    vfac1: OCP.gp.gp_Vec2d,
    sens2: int,
    pfac2: OCP.gp.gp_Pnt2d,
    vfac2: OCP.gp.gp_Vec2d,
    t3d: float,
    ta: float,
) -> OCP.GeomFill.GeomFill_Boundary:
    pass
