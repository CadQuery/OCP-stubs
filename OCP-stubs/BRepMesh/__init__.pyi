...
class BRepMesh_CircleInspector(OCP.NCollection.NCollection_CellFilter_InspectorXY):
    ...
    def GetShotCircles(self) -> Any:
        ...
        """
    def Inspect(
        self, theTargetIndex: int
    ) -> OCP.NCollection.NCollection_CellFilter_Action:
        """
    ...
    def __init__(
        ...
        theTolerance: float,
        theReservedSize: int,
        theAllocator: OCP.NCollection.NCollection_IncAllocator,
    ) -> None: ...
    pass
...
class BRepMesh_CircleTool:
    ...
    def Bind(
        self,
        theIndex: int,
        thePoint1: OCP.gp.gp_XY,
        thePoint2: OCP.gp.gp_XY,
        thePoint3: OCP.gp.gp_XY,
    ) -> bool: ...
    ...
    @overload
    def __init__(
        self, theAllocator: OCP.NCollection.NCollection_IncAllocator
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class BRepMesh_Classifier(OCP.Standard.Standard_Transient):
    ...
    def RegisterWire(
        self,
        theWire: Any,
        theTolUV: Tuple[floatfloat],
        theRangeU: Tuple[floatfloat],
        theRangeV: Tuple[floatfloat],
    ) -> None:
        """
...
class BRepMesh_CurveTessellator:
    ...
    def PointsNb(self) -> int:
        ...
        """
    def Value(
        self, theIndex: int, thePoint: OCP.gp.gp_Pnt, theParameter: float
    ) -> bool:
        """
    ...
    @overload
    def __init__(
        self, theEdge: IMeshData_Edge, theParameters: IMeshTools_Parameters
    ) -> None: ...
    @overload
    def __init__(
        self,
        theEdge: IMeshData_Edge,
        theOrientation: OCP.TopAbs.TopAbs_Orientation,
        theFace: IMeshData_Face,
...
class BRepMesh_Deflection(OCP.Standard.Standard_Transient):
    ...
    @staticmethod
    def ComputeAbsoluteDeflection_s(
    ...
    @staticmethod
    @overload
    def ComputeDeflection_s(
        theDFace: IMeshData_Face, theParameters: IMeshTools_Parameters
    ) -> None:
        """
    ...
    @overload
    def ComputeDeflection_s(
        theDWire: IMeshData_Wire, theParameters: IMeshTools_Parameters
    ) -> None: ...
    @staticmethod
    @overload
    def ComputeDeflection_s(
        theDEdge: IMeshData_Edge,
        theMaxShapeSize: float,
        theParameters: IMeshTools_Parameters,
    ) -> None: ...
    def DecrementRefCounter(self) -> int:
...
class BRepMesh_DiscretFactory:
    ...
    def SetDefault(
        self,
        theName: OCP.TCollection.TCollection_AsciiString,
        theFuncName: OCP.TCollection.TCollection_AsciiString = OCP.TCollection.TCollection_AsciiString,
    ) -> bool:
        """
    ...
    def SetDefaultName(self, theName: OCP.TCollection.TCollection_AsciiString) -> bool:
        ...
        """
    def SetFunctionName(
        self, theFuncName: OCP.TCollection.TCollection_AsciiString
    ) -> bool:
        """
...
class BRepMesh_EdgeDiscret:
    ...
    @staticmethod
    def CreateEdgeTessellationExtractor_s(
        theDEdge: IMeshData_Edge, theDFace: IMeshData_Face
    ...
    @staticmethod
    @overload
    def CreateEdgeTessellator_s(
        theDEdge: IMeshData_Edge,
        theOrientation: OCP.TopAbs.TopAbs_Orientation,
        theDFace: IMeshData_Face,
        theParameters: IMeshTools_Parameters,
    ) -> IMeshTools_CurveTessellator:
        """
    ...
    @overload
    def CreateEdgeTessellator_s(
        theDEdge: IMeshData_Edge, theParameters: IMeshTools_Parameters
    ) -> IMeshTools_CurveTessellator: ...
    def DynamicType(self) -> OCP.Standard.Standard_Type:
        """
        None
...
class BRepMesh_FaceChecker(OCP.Standard.Standard_Transient):
    ...
    def This(self) -> OCP.Standard.Standard_Transient:
        ...
        """
    def __init__(
        self, theFace: IMeshData_Face, theParameters: IMeshTools_Parameters
    ) -> None: ...
    @staticmethod
    def get_type_descriptor_s() -> OCP.Standard.Standard_Type:
        """
...
class BRepMesh_GeomTool:
    ...
    def AddPoint(
        self, thePoint: OCP.gp.gp_Pnt, theParam: float, theIsReplace: bool = True
    ) -> int:
        """
    ...
    @staticmethod
    def IntSegSeg_s(
        theStartPnt1: OCP.gp.gp_XY,
        theEndPnt1: OCP.gp.gp_XY,
        theStartPnt2: OCP.gp.gp_XY,
        theEndPnt2: OCP.gp.gp_XY,
        isConsiderEndPointTouch: bool,
        isConsiderPointOnSegment: bool,
        theIntPnt: OCP.gp.gp_Pnt2d,
    ) -> Any:
        """
    ...
    @staticmethod
    def Normal_s(
        theSurface: OCP.BRepAdaptor.BRepAdaptor_HSurface,
        theParamU: float,
        theParamV: float,
        thePoint: OCP.gp.gp_Pnt,
        theNormal: OCP.gp.gp_Dir,
    ) -> bool:
        """
        Computes normal to the given surface at the specified position in parametric space.
        """
    @staticmethod
    def SquareDeflectionOfSegment_s(
        theFirstPoint: OCP.gp.gp_Pnt,
        theLastPoint: OCP.gp.gp_Pnt,
        theMidPoint: OCP.gp.gp_Pnt,
    ) -> float:
        """
    ...
    def __init__(
        self,
        theSurface: OCP.BRepAdaptor.BRepAdaptor_HSurface,
        theIsoType: OCP.GeomAbs.GeomAbs_IsoType,
        theParamIso: float,
        theFirstParam: float,
        theLastParam: float,
        theLinDeflection: float,
        ...
        theMinSize: float = 1e-07,
    ) -> None: ...
    @overload
    def __init__(
        self,
        theCurve: OCP.BRepAdaptor.BRepAdaptor_Curve,
        theFirstParam: float,
        theLastParam: float,
        theLinDeflection: float,
        theAngDeflection: float,
...
class BRepMesh_IncrementalMesh(BRepMesh_DiscretRoot, OCP.Standard.Standard_Transient):
    ...
    @overload
    def __init__(
        self, theShape: OCP.TopoDS.TopoDS_Shape, theParameters: IMeshTools_Parameters
    ) -> None: ...
    @overload
    def __init__(self) -> None: ...
    @overload
...
class BRepMesh_MeshAlgoFactory:
    ...
    def GetAlgo(
        self,
        theSurfaceType: OCP.GeomAbs.GeomAbs_SurfaceType,
        theParameters: IMeshTools_Parameters,
    ) -> IMeshTools_MeshAlgo:
        """
...
class BRepMesh_ShapeTool(OCP.Standard.Standard_Transient):
    ...
    @staticmethod
    def AddInFace_s(
        theFace: OCP.TopoDS.TopoDS_Face, theTriangulation: OCP.Poly.Poly_Triangulation
    ) -> None:
        """
    ...
    def BoxMaxDimension_s(theBox: OCP.Bnd.Bnd_Box) -> Tuple[float]:
        ...
        """
    @staticmethod
    def CheckAndUpdateFlags_s(
        theEdge: IMeshData_Edge, thePCurve: IMeshData_PCurve
    ) -> None:
        """
    ...
    @overload
    def NullifyEdge_s(
        theEdge: OCP.TopoDS.TopoDS_Edge, theLocation: OCP.TopLoc.TopLoc_Location
    ) -> None:
        """
    ...
    def NullifyEdge_s(
        ...
        theTriangulation: OCP.Poly.Poly_Triangulation,
        theLocation: OCP.TopLoc.TopLoc_Location,
    ) -> None: ...
    @staticmethod
    ...
    def Range_s(
        ...
        thePCurve: OCP.Geom2d.Geom2d_Curve,
        theFirstParam: float,
        theLastParam: float,
        isConsiderOrientation: bool = False,
    ) -> bool:
        """
    ...
    def UVPoints_s(
        theEdge: OCP.TopoDS.TopoDS_Edge,
        theFace: OCP.TopoDS.TopoDS_Face,
        theFirstPoint2d: OCP.gp.gp_Pnt2d,
        theLastPoint2d: OCP.gp.gp_Pnt2d,
        isConsiderOrientation: bool = False,
    ) -> bool:
        """
    ...
    def UpdateEdge_s(
        theEdge: OCP.TopoDS.TopoDS_Edge,
        thePolygon: OCP.Poly.Poly_PolygonOnTriangulation,
        theTriangulation: OCP.Poly.Poly_Triangulation,
        theLocation: OCP.TopLoc.TopLoc_Location,
    ) -> None:
        """
    ...
    @overload
    def UpdateEdge_s(
        theEdge: OCP.TopoDS.TopoDS_Edge, thePolygon: OCP.Poly.Poly_Polygon3D
    ) -> None: ...
    @staticmethod
    @overload
    def UpdateEdge_s(
        theEdge: OCP.TopoDS.TopoDS_Edge,
        thePolygon1: OCP.Poly.Poly_PolygonOnTriangulation,
        thePolygon2: OCP.Poly.Poly_PolygonOnTriangulation,
        theTriangulation: OCP.Poly.Poly_Triangulation,
        theLocation: OCP.TopLoc.TopLoc_Location,
    ) -> None: ...
    @staticmethod
    def UseLocation_s(
        thePnt: OCP.gp.gp_Pnt, theLoc: OCP.TopLoc.TopLoc_Location
    ) -> OCP.gp.gp_Pnt:
        """
