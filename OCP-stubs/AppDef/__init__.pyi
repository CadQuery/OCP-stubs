...
class AppDef_Array1OfMultiPointConstraint:
    ...
    def Assign(
        self, theOther: AppDef_Array1OfMultiPointConstraint
    ) -> AppDef_Array1OfMultiPointConstraint:
        """
    ...
    @overload
    def __init__(
        self, theBegin: AppDef_MultiPointConstraint, theLower: int, theUpper: int
    ) -> None: ...
    @overload
...
class AppDef_HArray1OfMultiPointConstraint(
    AppDef_Array1OfMultiPointConstraint, OCP.Standard.Standard_Transient
):
    ...
    @overload
    def __init__(
        self, theLower: int, theUpper: int, theValue: AppDef_MultiPointConstraint
    ) -> None: ...
    @overload
    def __init__(self, theOther: AppDef_Array1OfMultiPointConstraint) -> None: ...
    @overload
...
class AppDef_SmoothCriterion(OCP.Standard.Standard_Transient):
    ...
    def Gradient(self, Element: int, Dimension: int, G: OCP.math.math_Vector) -> None:
        ...
        """
    def Hessian(
        self, Element: int, Dimension1: int, Dimension2: int, H: OCP.math.math_Matrix
    ) -> None:
        """
        None
        """
    def IncrementRefCounter(self) -> None:
        ...
        """
    def InputVector(
        self, X: OCP.math.math_Vector, AssTable: OCP.FEmTool.FEmTool_HAssemblyTable
    ) -> None:
        """
    ...
    def IsKind(self, theTypeName: str) -> bool: ...
    def QualityValues(
        self, J1min: float, J2min: float, J3min: float, J1: float, J2: float, J3: float
    ) -> int:
        """
        None
        """
...
class AppDef_MultiPointConstraint(OCP.AppParCurves.AppParCurves_MultiPoint):
    ...
    def __init__(
        self,
        tabP: OCP.TColgp.TColgp_Array1OfPnt,
        tabP2d: OCP.TColgp.TColgp_Array1OfPnt2d,
    ) -> None: ...
    @overload
    def __init__(self) -> None: ...
    @overload
    ...
    def __init__(
        ...
        tabP: OCP.TColgp.TColgp_Array1OfPnt,
        tabP2d: OCP.TColgp.TColgp_Array1OfPnt2d,
        tabVec: OCP.TColgp.TColgp_Array1OfVec,
        tabVec2d: OCP.TColgp.TColgp_Array1OfVec2d,
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    def __init__(
        ...
        tabVec: OCP.TColgp.TColgp_Array1OfVec,
        tabVec2d: OCP.TColgp.TColgp_Array1OfVec2d,
        tabCur: OCP.TColgp.TColgp_Array1OfVec,
        tabCur2d: OCP.TColgp.TColgp_Array1OfVec2d,
    ) -> None: ...
    @overload
    def __init__(
        self, tabP: OCP.TColgp.TColgp_Array1OfPnt, tabVec: OCP.TColgp.TColgp_Array1OfVec
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class AppDef_MyLineTool:
    ...
    @overload
    def Curvature_s(
        ML: AppDef_MultiLine, MPointIndex: int, tabV2d: OCP.TColgp.TColgp_Array1OfVec2d
    ) -> bool:
        """
    ...
    @overload
    def Curvature_s(
        ML: AppDef_MultiLine, MPointIndex: int, tabV: OCP.TColgp.TColgp_Array1OfVec
    ) -> bool: ...
    @staticmethod
    ...
    @overload
    def Value_s(
        ML: AppDef_MultiLine, MPointIndex: int, tabPt: OCP.TColgp.TColgp_Array1OfPnt
    ) -> None:
        """
        returns the 3d points of the multipoint <MPointIndex> when only 3d points exist.
    ...
    @overload
    def Value_s(
        ML: AppDef_MultiLine, MPointIndex: int, tabPt2d: OCP.TColgp.TColgp_Array1OfPnt2d
    ) -> None: ...
    @staticmethod
    def WhatStatus_s(
        ML: AppDef_MultiLine, I1: int, I2: int
...
class AppDef_Variational:
    ...
    def QuadraticError(self) -> float:
        ...
        """
    def SetConstraints(
        self, aConstrainst: OCP.AppParCurves.AppParCurves_HArray1OfConstraintCouple
    ) -> bool:
        """
    ...
    def __init__(
        ...
        MaxDegree: int = 14,
        MaxSegment: int = 100,
        Continuity: OCP.GeomAbs.GeomAbs_Shape = GeomAbs_Shape.GeomAbs_C2,
        WithMinMax: bool = False,
        WithCutting: bool = True,
        Tolerance: float = 1.0,
        NbIterations: int = 2,
    ) -> None: ...
    pass
