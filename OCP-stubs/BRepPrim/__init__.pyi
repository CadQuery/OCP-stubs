...
class BRepPrim_Builder:
    ...
    def AddFaceWire(self, F: OCP.TopoDS.TopoDS_Face, W: OCP.TopoDS.TopoDS_Wire) -> None:
        ...
        """
    def AddShellFace(
        self, Sh: OCP.TopoDS.TopoDS_Shell, F: OCP.TopoDS.TopoDS_Face
    ) -> None:
        """
        Adds the Face <F> in the Shell <Sh>.
        """
    def AddWireEdge(
        self, W: OCP.TopoDS.TopoDS_Wire, E: OCP.TopoDS.TopoDS_Edge, direct: bool
    ) -> None:
        """
    ...
    @overload
    def SetPCurve(
        self, E: OCP.TopoDS.TopoDS_Edge, F: OCP.TopoDS.TopoDS_Face, L: OCP.gp.gp_Lin2d
    ) -> None: ...
    @overload
    def SetPCurve(
        self, E: OCP.TopoDS.TopoDS_Edge, F: OCP.TopoDS.TopoDS_Face, C: OCP.gp.gp_Circ2d
    ) -> None: ...
    def SetParameters(
        self,
        E: OCP.TopoDS.TopoDS_Edge,
...
class BRepPrim_Revolution(BRepPrim_OneAxis):
    ...
    def __init__(
        ...
        VMin: float,
        VMax: float,
        M: OCP.Geom.Geom_Curve,
        PM: OCP.Geom2d.Geom2d_Curve,
    ) -> None: ...
    pass
...
class BRepPrim_GWedge:
    ...
    def Close(self, d1: BRepPrim_Direction) -> None:
        ...
        """
    def Edge(
        self, d1: BRepPrim_Direction, d2: BRepPrim_Direction
    ...
    @overload
    def __init__(
        self, B: BRepPrim_Builder, Axes: OCP.gp.gp_Ax2, dx: float, dy: float, dz: float
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class BRepPrim_Cone(BRepPrim_Revolution, BRepPrim_OneAxis):
    ...
    @overload
    def __init__(
        self, Center: OCP.gp.gp_Pnt, R1: float, R2: float, H: float
    ) -> None: ...
    @overload
    def __init__(self, Angle: float) -> None: ...
    @overload
    def __init__(
        self, Angle: float, Position: OCP.gp.gp_Ax2, Height: float, Radius: float = 0.0
    ) -> None: ...
    @overload
...
class BRepPrim_Cylinder(BRepPrim_Revolution, BRepPrim_OneAxis):
    ...
    @overload
    def __init__(
        self, Position: OCP.gp.gp_Ax2, Radius: float, Height: float
    ) -> None: ...
    @overload
...
class BRepPrim_Wedge(BRepPrim_GWedge):
    ...
    @overload
    def __init__(
        self, Axes: OCP.gp.gp_Ax2, dx: float, dy: float, dz: float
    ) -> None: ...
    @overload
    def __init__(
        self, Axes: OCP.gp.gp_Ax2, dx: float, dy: float, dz: float, ltx: float
    ) -> None: ...
    pass
