...
class BRepOffsetAPI_DraftAngle(
    OCP.BRepBuilderAPI.BRepBuilderAPI_ModifyShape,
    ...
    def Add(
        ...
        Direction: OCP.gp.gp_Dir,
        Angle: float,
        NeutralPlane: OCP.gp.gp_Pln,
        Flag: bool = True,
    ) -> None:
        """
...
class BRepOffsetAPI_FindContigousEdges:
    ...
    def SectionToBoundary(
        self, section: OCP.TopoDS.TopoDS_Edge
...
class BRepOffsetAPI_MakeDraft(
    ...
    @overload
    def Perform(
        self, StopShape: OCP.TopoDS.TopoDS_Shape, KeepOutSide: bool = True
    ) -> None:
        """
    ...
    @overload
    def Perform(
        self, Surface: OCP.Geom.Geom_Surface, KeepInsideSurface: bool = True
    ) -> None: ...
    ...
    def SetOptions(
        self,
        Style: OCP.BRepBuilderAPI.BRepBuilderAPI_TransitionMode = BRepBuilderAPI_TransitionMode.BRepBuilderAPI_RightCorner,
        AngleMin: float = 0.01,
        AngleMax: float = 3.0,
    ) -> None:
        """
    ...
    def Shell(self) -> OCP.TopoDS.TopoDS_Shell:
        ...
        """
    def __init__(
        self, Shape: OCP.TopoDS.TopoDS_Shape, Dir: OCP.gp.gp_Dir, Angle: float
    ) -> None: ...
    pass
...
class BRepOffsetAPI_MakeEvolved(
    ...
    def Generated(
        ...
        """
    def GeneratedShapes(
        self, SpineShape: OCP.TopoDS.TopoDS_Shape, ProfShape: OCP.TopoDS.TopoDS_Shape
    ) -> OCP.TopTools.TopTools_ListOfShape:
        """
    ...
    def __init__(
        self,
        theSpine: OCP.TopoDS.TopoDS_Shape,
        theProfile: OCP.TopoDS.TopoDS_Wire,
        theJoinType: OCP.GeomAbs.GeomAbs_JoinType = GeomAbs_JoinType.GeomAbs_Arc,
        theIsAxeProf: bool = True,
        theIsSolid: bool = False,
        theIsProfOnSpine: bool = False,
        theTol: float = 1e-07,
        theIsVolume: bool = False,
        theRunInParallel: bool = False,
    ) -> None: ...
    @overload
    def __init__(self) -> None: ...
    pass
...
class BRepOffsetAPI_MakeFilling(
    ...
    @overload
    def Add(
        self, Support: OCP.TopoDS.TopoDS_Face, Order: OCP.GeomAbs.GeomAbs_Shape
    ) -> int:
        """
    ...
    def Add(
        ...
        U: float,
        V: float,
        Support: OCP.TopoDS.TopoDS_Face,
        Order: OCP.GeomAbs.GeomAbs_Shape,
    ) -> int: ...
    @overload
    def Add(
...
class BRepOffsetAPI_MakeOffsetShape(
    ...
    def PerformByJoin(
        ...
        Offset: float,
        Tol: float,
        Mode: OCP.BRepOffset.BRepOffset_Mode = BRepOffset_Mode.BRepOffset_Skin,
        ...
        """
    def PerformBySimple(
        self, theS: OCP.TopoDS.TopoDS_Shape, theOffsetValue: float
    ) -> None:
        """
...
class BRepOffsetAPI_MakePipe(
    OCP.BRepPrimAPI.BRepPrimAPI_MakeSweep,
    OCP.BRepBuilderAPI.BRepBuilderAPI_MakeShape,
    OCP.BRepBuilderAPI.BRepBuilderAPI_Command,
):
    """
    ...
    @overload
    def Generated(
        self, SSpine: OCP.TopoDS.TopoDS_Shape, SProfile: OCP.TopoDS.TopoDS_Shape
    ...
    @overload
    def __init__(
        self, Spine: OCP.TopoDS.TopoDS_Wire, Profile: OCP.TopoDS.TopoDS_Shape
    ) -> None: ...
    @overload
    def __init__(
        self,
        Spine: OCP.TopoDS.TopoDS_Wire,
        Profile: OCP.TopoDS.TopoDS_Shape,
        aMode: OCP.GeomFill.GeomFill_Trihedron,
...
class BRepOffsetAPI_MakePipeShell(
    ...
    def Add(
        self,
        Profile: OCP.TopoDS.TopoDS_Shape,
        Location: OCP.TopoDS.TopoDS_Vertex,
        WithContact: bool = False,
        WithCorrection: bool = False,
    ) -> None: ...
    def Build(self) -> None:
    ...
    def SetMode(
        self,
        AuxiliarySpine: OCP.TopoDS.TopoDS_Wire,
        CurvilinearEquivalence: bool,
        KeepContact: OCP.BRepFill.BRepFill_TypeOfContact = BRepFill_TypeOfContact.BRepFill_NoContact,
    ) -> None: ...
    def SetTolerance(
        self, Tol3d: float = 0.0001, BoundTol: float = 0.0001, TolAngular: float = 0.01
    ) -> None:
        """
    ...
    def SetTransitionMode(
        self,
        Mode: OCP.BRepBuilderAPI.BRepBuilderAPI_TransitionMode = BRepBuilderAPI_TransitionMode.BRepBuilderAPI_Transformed,
    ) -> None:
        """
    ...
    def Shape(self) -> OCP.TopoDS.TopoDS_Shape:
        ...
        """
    def Simulate(
        self, NumberOfSection: int, Result: OCP.TopTools.TopTools_ListOfShape
    ) -> None:
        """
...
class BRepOffsetAPI_MakeThickSolid(
    ...
    def MakeThickSolidByJoin(
        self,
        S: OCP.TopoDS.TopoDS_Shape,
        ClosingFaces: OCP.TopTools.TopTools_ListOfShape,
        Offset: float,
        Tol: float,
        Mode: OCP.BRepOffset.BRepOffset_Mode = BRepOffset_Mode.BRepOffset_Skin,
        Intersection: bool = False,
...
class BRepOffsetAPI_MiddlePath(
    ...
    def __init__(
        self,
        aShape: OCP.TopoDS.TopoDS_Shape,
        StartShape: OCP.TopoDS.TopoDS_Shape,
        EndShape: OCP.TopoDS.TopoDS_Shape,
    ) -> None: ...
    pass
...
class BRepOffsetAPI_NormalProjection(
    ...
    def SetParams(
        ...
        Tol3D: float,
        Tol2D: float,
        InternalContinuity: OCP.GeomAbs.GeomAbs_Shape,
        MaxDegree: int,
        MaxSeg: int,
    ) -> None:
        """
...
class BRepOffsetAPI_SequenceOfSequenceOfReal(OCP.NCollection.NCollection_BaseSequence):
    ...
    def Assign(
        self, theOther: BRepOffsetAPI_SequenceOfSequenceOfReal
    ) -> BRepOffsetAPI_SequenceOfSequenceOfReal:
        """
    ...
    @overload
    def InsertAfter(
        self, theIndex: int, theItem: OCP.TColStd.TColStd_SequenceOfReal
    ) -> None:
        """
    ...
    @overload
    def InsertAfter(
        self, theIndex: int, theSeq: BRepOffsetAPI_SequenceOfSequenceOfReal
    ) -> None: ...
    @overload
    def InsertBefore(
        self, theIndex: int, theSeq: BRepOffsetAPI_SequenceOfSequenceOfReal
...
class BRepOffsetAPI_SequenceOfSequenceOfShape(OCP.NCollection.NCollection_BaseSequence):
    ...
    def Assign(
        self, theOther: BRepOffsetAPI_SequenceOfSequenceOfShape
    ) -> BRepOffsetAPI_SequenceOfSequenceOfShape:
        """
        Replace this sequence by the items of theOther. This method does not change the internal allocator.
        """
    ...
    @overload
    def InsertAfter(
        self, theIndex: int, theSeq: BRepOffsetAPI_SequenceOfSequenceOfShape
    ) -> None:
        """
        InsertAfter theIndex another sequence (making it empty)
    ...
    @overload
    def InsertAfter(
        self, theIndex: int, theItem: OCP.TopTools.TopTools_SequenceOfShape
    ) -> None: ...
    @overload
    def InsertBefore(
        self, theIndex: int, theItem: OCP.TopTools.TopTools_SequenceOfShape
...
class BRepOffsetAPI_ThruSections(
    ...
    def GeneratedFace(self, Edge: OCP.TopoDS.TopoDS_Shape) -> OCP.TopoDS.TopoDS_Shape:
        ...
        """
    def Init(
        self, isSolid: bool = False, ruled: bool = False, pres3d: float = 1e-06
    ) -> None:
        """
