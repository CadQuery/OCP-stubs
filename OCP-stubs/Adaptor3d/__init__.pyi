...
class Adaptor3d_CurveOnSurface(Adaptor3d_Curve):
    ...
    @overload
    def Load(
        self, C: OCP.Adaptor2d.Adaptor2d_HCurve2d, S: Adaptor3d_HSurface
    ) -> None: ...
    @overload
...
class Adaptor3d_HSurfaceTool:
    ...
    @staticmethod
    def DN_s(
        S: Adaptor3d_HSurface, u: float, v: float, Nu: int, Nv: int
    ) -> OCP.gp.gp_Vec:
        """
        None
        """
    ...
    @staticmethod
    def UTrim_s(
        S: Adaptor3d_HSurface, First: float, Last: float, Tol: float
    ) -> Adaptor3d_HSurface:
        """
        If <First> >= <Last>
        """
...
class Adaptor3d_HVertex(OCP.Standard.Standard_Transient):
    ...
    @overload
    def __init__(
        self, P: OCP.gp.gp_Pnt2d, Ori: OCP.TopAbs.TopAbs_Orientation, Resolution: float
    ) -> None: ...
    @staticmethod
    def get_type_descriptor_s() -> OCP.Standard.Standard_Type:
        """
...
class Adaptor3d_InterFunc(OCP.math.math_FunctionWithDerivative, OCP.math.math_Function):
    ...
    def Values(self, X: float, F: float, D: float) -> bool:
        ...
        """
    def __init__(
        self, C: OCP.Adaptor2d.Adaptor2d_HCurve2d, FixVal: float, Fix: int
    ) -> None: ...
    pass
...
class Adaptor3d_IsoCurve(Adaptor3d_Curve):
    ...
    def Load(
        self,
        Iso: OCP.GeomAbs.GeomAbs_IsoType,
        Param: float,
        WFirst: float,
        WLast: float,
    ) -> None: ...
    ...
    @overload
    def __init__(
        self, S: Adaptor3d_HSurface, Iso: OCP.GeomAbs.GeomAbs_IsoType, Param: float
    ) -> None: ...
    @overload
    def __init__(self) -> None: ...
    @overload
...
class Adaptor3d_TopolTool(OCP.Standard.Standard_Transient):
    ...
    def BSplSamplePnts(self, theDefl: float, theNUmin: int, theNVmin: int) -> None:
        ...
        """
    def Classify(
        self, P: OCP.gp.gp_Pnt2d, Tol: float, ReacdreOnPeriodic: bool = True
    ...
    @overload
    def Orientation(
        self, C: OCP.Adaptor2d.Adaptor2d_HCurve2d
