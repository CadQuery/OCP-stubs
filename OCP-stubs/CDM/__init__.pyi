...
class CDM_Document(OCP.Standard.Standard_Transient):
    ...
    def DynamicType(self) -> OCP.Standard.Standard_Type:
        ...
        """
    def Extensions(
        self, Extensions: OCP.TColStd.TColStd_SequenceOfExtendedString
    ) -> None:
        """
    ...
    def FindFileExtension(self) -> bool:
        ...
        """
    @staticmethod
    def FindFromPresentation_s(
        aPresentation: OCP.TCollection.TCollection_ExtendedString,
    ) -> CDM_Document:
        """
        returns the document having the given alphanumeric presentation.
        """
    @staticmethod
    def FindPresentation_s(
        aPresentation: OCP.TCollection.TCollection_ExtendedString,
    ) -> bool:
        """
    ...
    def GetAlternativeDocument(
        self,
        aFormat: OCP.TCollection.TCollection_ExtendedString,
    ...
    def SetComment(self, aComment: OCP.TCollection.TCollection_ExtendedString) -> None:
        ...
        """
    def SetComments(
        self, aComments: OCP.TColStd.TColStd_SequenceOfExtendedString
    ) -> None:
        """
    ...
    @overload
    def Update(
        self, ErrorString: OCP.TCollection.TCollection_ExtendedString
    ) -> bool: ...
...
class CDM_MapOfDocument(OCP.NCollection.NCollection_BaseMap):
    ...
    def Differ(self, theOther: CDM_MapOfDocument) -> bool:
        ...
        """
    def Difference(
        self, theLeft: CDM_MapOfDocument, theRight: CDM_MapOfDocument
    ) -> None:
        """
...
class CDM_MetaData(OCP.Standard.Standard_Transient):
    ...
    def LookUp_s(
        ...
        aPath: OCP.TCollection.TCollection_ExtendedString,
