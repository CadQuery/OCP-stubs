...
class BRepClass_FClassifier:
    ...
    def NoWires(self) -> bool:
        ...
        """
    def Perform(
        self, F: BRepClass_FaceExplorer, P: OCP.gp.gp_Pnt2d, Tol: float
    ) -> None:
        """
...
class BRepClass_FaceClassifier(BRepClass_FClassifier):
    ...
    @overload
    def Perform(
        self, F: OCP.TopoDS.TopoDS_Face, P: OCP.gp.gp_Pnt2d, Tol: float
    ) -> None: ...
    def Position(self) -> OCP.IntRes2d.IntRes2d_Position:
        """
        Returns the position of the point on the edge returned by Edge.
    ...
    @overload
    def __init__(
        self, F: OCP.TopoDS.TopoDS_Face, P: OCP.gp.gp_Pnt, Tol: float
    ) -> None: ...
    @overload
    def __init__(self) -> None: ...
    pass
...
class BRepClass_Intersector(
    OCP.Geom2dInt.Geom2dInt_IntConicCurveOfGInter, OCP.IntRes2d.IntRes2d_Intersection
):
    """
    ...
    def IsEmpty(self) -> bool:
        ...
        """
    def LocalGeometry(
        self, E: BRepClass_Edge, U: float, T: OCP.gp.gp_Dir2d, N: OCP.gp.gp_Dir2d
    ) -> Tuple[float]:
        """
    ...
    def NbSegments(self) -> int:
        ...
        """
    def Perform(
        self, L: OCP.gp.gp_Lin2d, P: float, Tol: float, E: BRepClass_Edge
    ) -> None:
        """
