...
class BRepCheck_Analyzer:
    ...
    def __init__(
        self, S: OCP.TopoDS.TopoDS_Shape, GeomControls: bool = True
    ) -> None: ...
    pass
...
class BRepCheck_DataMapOfShapeListOfStatus(OCP.NCollection.NCollection_BaseMap):
    ...
    def Allocator(self) -> OCP.NCollection.NCollection_BaseAllocator:
        ...
        """
    def Assign(
        self, theOther: BRepCheck_DataMapOfShapeListOfStatus
    ) -> BRepCheck_DataMapOfShapeListOfStatus:
        """
        Assignment. This method does not change the internal allocator.
        """
    def Bind(
        self, theKey: OCP.TopoDS.TopoDS_Shape, theItem: BRepCheck_ListOfStatus
    ) -> bool:
        """
    ...
    @overload
    def Find(
        self, theKey: OCP.TopoDS.TopoDS_Shape, theValue: BRepCheck_ListOfStatus
    ) -> bool:
        """
...
class BRepCheck_ListOfStatus(OCP.NCollection.NCollection_BaseList):
    ...
    @overload
    def InsertBefore(
        self, theItem: BRepCheck_Status, theIter: Any
    ) -> BRepCheck_Status: ...
    def IsEmpty(self) -> bool:
        """
        None
...
class BRepCheck_Edge(BRepCheck_Result, OCP.Standard.Standard_Transient):
    ...
    def CheckPolygonOnTriangulation(
        self, theEdge: OCP.TopoDS.TopoDS_Edge
    ) -> BRepCheck_Status:
        """
...
class BRepCheck_Wire(BRepCheck_Result, OCP.Standard.Standard_Transient):
    ...
    def Closed(self, Update: bool = False) -> BRepCheck_Status:
        ...
        """
    def Closed2d(
        self, F: OCP.TopoDS.TopoDS_Face, Update: bool = False
    ) -> BRepCheck_Status:
        """
