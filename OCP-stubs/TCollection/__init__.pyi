...
class TCollection_ExtendedString():
    ...
    def ToWideString(self) -> str: 
        """
        Returns pointer to string as wchar_t* on Windows platform where wchar_t* is considered as UTF-16 string. This method is useful to pass string into wide-char system APIs, and makes sense only on Windows (other systems use UTF-8 and can miss wide-char functions at all).
        """
