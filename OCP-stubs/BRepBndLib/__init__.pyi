...
class BRepBndLib:
    ...
    def AddOBB_s(
        ...
        theOBB: OCP.Bnd.Bnd_OBB,
        theIsTriangulationUsed: bool = True,
        theIsOptimal: bool = False,
    ...
    @staticmethod
    def Add_s(
        S: OCP.TopoDS.TopoDS_Shape, B: OCP.Bnd.Bnd_Box, useTriangulation: bool = True
    ) -> None:
        """
