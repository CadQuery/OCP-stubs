...
class GCPnts_AbscissaType():
    ...
    def name(self) -> str:
        ...
        :type: str
        """
    GCPnts_AbsComposite: OCP.GCPnts.GCPnts_AbscissaType # value = GCPnts_AbscissaType.GCPnts_AbsComposite
    GCPnts_LengthParametrized: OCP.GCPnts.GCPnts_AbscissaType # value = GCPnts_AbscissaType.GCPnts_LengthParametrized
    GCPnts_Parametrized: OCP.GCPnts.GCPnts_AbscissaType # value = GCPnts_AbscissaType.GCPnts_Parametrized
    __entries: dict # value = {'GCPnts_LengthParametrized': (GCPnts_AbscissaType.GCPnts_LengthParametrized, None), 'GCPnts_Parametrized': (GCPnts_AbscissaType.GCPnts_Parametrized, None), 'GCPnts_AbsComposite': (GCPnts_AbscissaType.GCPnts_AbsComposite, None)}
    __members__: dict # value = {'GCPnts_LengthParametrized': GCPnts_AbscissaType.GCPnts_LengthParametrized, 'GCPnts_Parametrized': GCPnts_AbscissaType.GCPnts_Parametrized, 'GCPnts_AbsComposite': GCPnts_AbscissaType.GCPnts_AbsComposite}
    pass
class GCPnts_DeflectionType():
    ...
    def name(self) -> str:
        ...
        :type: str
        """
    GCPnts_Circular: OCP.GCPnts.GCPnts_DeflectionType # value = GCPnts_DeflectionType.GCPnts_Circular
    GCPnts_Curved: OCP.GCPnts.GCPnts_DeflectionType # value = GCPnts_DeflectionType.GCPnts_Curved
    GCPnts_DefComposite: OCP.GCPnts.GCPnts_DeflectionType # value = GCPnts_DeflectionType.GCPnts_DefComposite
    GCPnts_Linear: OCP.GCPnts.GCPnts_DeflectionType # value = GCPnts_DeflectionType.GCPnts_Linear
    __entries: dict # value = {'GCPnts_Linear': (GCPnts_DeflectionType.GCPnts_Linear, None), 'GCPnts_Circular': (GCPnts_DeflectionType.GCPnts_Circular, None), 'GCPnts_Curved': (GCPnts_DeflectionType.GCPnts_Curved, None), 'GCPnts_DefComposite': (GCPnts_DeflectionType.GCPnts_DefComposite, None)}
    __members__: dict # value = {'GCPnts_Linear': GCPnts_DeflectionType.GCPnts_Linear, 'GCPnts_Circular': GCPnts_DeflectionType.GCPnts_Circular, 'GCPnts_Curved': GCPnts_DeflectionType.GCPnts_Curved, 'GCPnts_DefComposite': GCPnts_DeflectionType.GCPnts_DefComposite}
    pass
