...
class BRepApprox_Approx:
    ...
    def Perform(
        self,
        aLine: BRepApprox_ApproxLine,
        ApproxXYZ: bool = True,
        ApproxU1V1: bool = True,
        ApproxU2V2: bool = True,
        indicemin: int = 0,
        indicemax: int = 0,
    ) -> None:
        """
    ...
    def Perform(
        self,
        Surf1: OCP.BRepAdaptor.BRepAdaptor_Surface,
        Surf2: OCP.BRepAdaptor.BRepAdaptor_Surface,
        aLine: BRepApprox_ApproxLine,
        ApproxXYZ: bool = True,
        ApproxU1V1: bool = True,
        ApproxU2V2: bool = True,
    ...
    def SetParameters(
        ...
        NbIterMax: int,
        NbPntMax: int = 30,
        ApproxWithTangency: bool = True,
        Parametrization: OCP.Approx.Approx_ParametrizationType = Approx_ParametrizationType.Approx_ChordLength,
    ) -> None:
        """
        None
        """
...
class BRepApprox_ApproxLine(OCP.Standard.Standard_Transient):
    ...
    def __init__(
        self,
        CurveXYZ: OCP.Geom.Geom_BSplineCurve,
        CurveUV1: OCP.Geom2d.Geom2d_BSplineCurve,
        CurveUV2: OCP.Geom2d.Geom2d_BSplineCurve,
    ) -> None: ...
    @overload
    def __init__(
        self, lin: OCP.IntSurf.IntSurf_LineOn2S, theTang: bool = False
    ) -> None: ...
    @staticmethod
...
class BRepApprox_BSpGradient_BFGSOfMyBSplGradientOfTheComputeLineOfApprox(
    ...
    def IsSolutionReached(
        self, F: OCP.math.math_MultipleVarFunctionWithGradient
    ) -> bool:
        """
        None
        """
    ...
    def Perform(
        self,
        F: OCP.math.math_MultipleVarFunctionWithGradient,
        StartingPoint: OCP.math.math_Vector,
    ) -> None:
        """
        ...
        """
    def SetBoundary(
        self, theLeftBorder: OCP.math.math_Vector, theRightBorder: OCP.math.math_Vector
    ) -> None:
        """
...
class BRepApprox_BSpParFunctionOfMyBSplGradientOfTheComputeLineOfApprox(
    OCP.math.math_MultipleVarFunctionWithGradient, OCP.math.math_MultipleVarFunction
):
    """
    None
    """
    ...
    def FirstConstraint(
        self,
        TheConstraints: OCP.AppParCurves.AppParCurves_HArray1OfConstraintCouple,
        FirstPoint: int,
    ) -> OCP.AppParCurves.AppParCurves_Constraint:
        """
        None
        """
    ...
    def Value(self, X: OCP.math.math_Vector, F: float) -> bool:
        ...
        """
    def Values(
        self, X: OCP.math.math_Vector, F: float, G: OCP.math.math_Vector
    ) -> bool:
        """
    ...
    def __init__(
        ...
        LastPoint: int,
        TheConstraints: OCP.AppParCurves.AppParCurves_HArray1OfConstraintCouple,
        Parameters: OCP.math.math_Vector,
        Knots: OCP.TColStd.TColStd_Array1OfReal,
        Mults: OCP.TColStd.TColStd_Array1OfInteger,
        NbPol: int,
    ) -> None: ...
    pass
...
class BRepApprox_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfApprox:
    ...
    def Perform(
        self,
        Parameters: OCP.math.math_Vector,
        V1t: OCP.math.math_Vector,
        V2t: OCP.math.math_Vector,
        V1c: OCP.math.math_Vector,
        V2c: OCP.math.math_Vector,
        l1: float,
        l2: float,
    ) -> None:
        """
    ...
    @overload
    def Perform(
        self, Parameters: OCP.math.math_Vector, l1: float, l2: float
    ) -> None: ...
    @overload
    def Perform(
        self,
...
class BRepApprox_ResConstraintOfMyGradientOfTheComputeLineBezierOfApprox:
    ...
    def ConstraintDerivative(
        ...
        Parameters: OCP.math.math_Vector,
        Deg: int,
        DA: OCP.math.math_Matrix,
    ) -> OCP.math.math_Matrix:
        """
    ...
    def __init__(
        self,
        SSP: BRepApprox_TheMultiLineOfApprox,
        SCurv: OCP.AppParCurves.AppParCurves_MultiCurve,
        FirstPoint: int,
        LastPoint: int,
        Constraints: OCP.AppParCurves.AppParCurves_HArray1OfConstraintCouple,
        Bern: OCP.math.math_Matrix,
        DerivativeBern: OCP.math.math_Matrix,
...
class BRepApprox_SurfaceTool:
    ...
    def BasisCurve_s(
        S: OCP.BRepAdaptor.BRepAdaptor_Surface,
    ) -> OCP.Adaptor3d.Adaptor3d_HCurve:
        """
        None
        """
    @staticmethod
    ...
    @staticmethod
    def D0_s(
        S: OCP.BRepAdaptor.BRepAdaptor_Surface, u: float, v: float, P: OCP.gp.gp_Pnt
    ) -> None:
        """
        None
        """
    ...
    @staticmethod
    def DN_s(
        S: OCP.BRepAdaptor.BRepAdaptor_Surface, u: float, v: float, Nu: int, Nv: int
    ) -> OCP.gp.gp_Vec:
        """
        None
        """
    ...
    def GetType_s(
        S: OCP.BRepAdaptor.BRepAdaptor_Surface,
    ) -> OCP.GeomAbs.GeomAbs_SurfaceType:
        """
        None
        """
    @staticmethod
    ...
    @overload
    def NbSamplesU_s(
        S: OCP.BRepAdaptor.BRepAdaptor_Surface, u1: float, u2: float
    ) -> int: ...
    @staticmethod
    @overload
    ...
    @overload
    def NbSamplesV_s(
        S: OCP.BRepAdaptor.BRepAdaptor_Surface, v1: float, v2: float
    ) -> int: ...
    @staticmethod
    def NbUIntervals_s(
        S: OCP.BRepAdaptor.BRepAdaptor_Surface, Sh: OCP.GeomAbs.GeomAbs_Shape
    ) -> int:
        """
        None
        """
    ...
    def UIntervals_s(
        S: OCP.BRepAdaptor.BRepAdaptor_Surface,
        T: OCP.TColStd.TColStd_Array1OfReal,
        Sh: OCP.GeomAbs.GeomAbs_Shape,
    ) -> None:
        """
        None
        """
    ...
    @staticmethod
    def UTrim_s(
        S: OCP.BRepAdaptor.BRepAdaptor_Surface, First: float, Last: float, Tol: float
    ) -> OCP.Adaptor3d.Adaptor3d_HSurface:
        """
        If <First> >= <Last>
        """
    @staticmethod
    ...
    @staticmethod
    def Value_s(
        S: OCP.BRepAdaptor.BRepAdaptor_Surface, u: float, v: float
    ) -> OCP.gp.gp_Pnt:
        """
        None
        """
...
class BRepApprox_TheComputeLineBezierOfApprox:
    ...
    def Init(
        ...
        degreemin: int = 4,
        degreemax: int = 8,
        Tolerance3d: float = 0.001,
        Tolerance2d: float = 1e-06,
        NbIterations: int = 5,
        cutting: bool = True,
        parametrization: OCP.Approx.Approx_ParametrizationType = Approx_ParametrizationType.Approx_ChordLength,
        Squares: bool = False,
    ...
    def SetConstraints(
        self,
        firstC: OCP.AppParCurves.AppParCurves_Constraint,
        lastC: OCP.AppParCurves.AppParCurves_Constraint,
    ) -> None:
        """
...
class BRepApprox_TheFunctionOfTheInt2SOfThePrmPrmSvSurfacesOfApprox(
    OCP.math.math_FunctionSetWithDerivatives, OCP.math.math_FunctionSet
):
    """
    None
    """
    ...
    def ComputeParameters(
        self,
        ChoixIso: OCP.IntImp.IntImp_ConstIsoparametric,
        Param: OCP.TColStd.TColStd_Array1OfReal,
        UVap: OCP.math.math_Vector,
        BornInf: OCP.math.math_Vector,
        BornSup: OCP.math.math_Vector,
        Tolerance: OCP.math.math_Vector,
    ) -> None:
        """
        None
        """
    ...
    def IsTangent(
        ...
        UVap: OCP.math.math_Vector,
        Param: OCP.TColStd.TColStd_Array1OfReal,
        BestChoix: OCP.IntImp.IntImp_ConstIsoparametric,
    ) -> bool:
        """
        None
        """
    ...
    def Value(self, X: OCP.math.math_Vector, F: OCP.math.math_Vector) -> bool:
        ...
        """
    def Values(
        self, X: OCP.math.math_Vector, F: OCP.math.math_Vector, D: OCP.math.math_Matrix
    ) -> bool:
        """
        None
        """
...
class BRepApprox_TheImpPrmSvSurfacesOfApprox:
    ...
    def Compute(
        ...
        Pt: OCP.gp.gp_Pnt,
        Tg: OCP.gp.gp_Vec,
        Tguv1: OCP.gp.gp_Vec2d,
        Tguv2: OCP.gp.gp_Vec2d,
    ) -> bool:
        """
    ...
    def SeekPoint(
        ...
        u2: float,
        v2: float,
        Point: OCP.IntSurf.IntSurf_PntOn2S,
    ) -> bool:
        """
        None
        """
    def Tangency(
        self, u1: float, v1: float, u2: float, v2: float, Tg: OCP.gp.gp_Vec
    ) -> bool:
        """
        None
        """
    def TangencyOnSurf1(
        self, u1: float, v1: float, u2: float, v2: float, Tg: OCP.gp.gp_Vec2d
    ) -> bool:
        """
        None
        """
    ...
    def __init__(
        self,
        Surf1: OCP.IntSurf.IntSurf_Quadric,
        Surf2: OCP.BRepAdaptor.BRepAdaptor_Surface,
    ) -> None: ...
    @overload
    def __init__(
        self,
        Surf1: OCP.BRepAdaptor.BRepAdaptor_Surface,
        Surf2: OCP.IntSurf.IntSurf_Quadric,
    ) -> None: ...
    pass
...
class BRepApprox_TheInt2SOfThePrmPrmSvSurfacesOfApprox:
    ...
    def Perform(
        self,
        Param: OCP.TColStd.TColStd_Array1OfReal,
        Rsnld: OCP.math.math_FunctionSetRoot,
        ChoixIso: OCP.IntImp.IntImp_ConstIsoparametric,
    ) -> OCP.IntImp.IntImp_ConstIsoparametric:
        """
...
class BRepApprox_TheMultiLineOfApprox:
    ...
    def Tangency(
        self,
        MPointIndex: int,
        tabV: OCP.TColgp.TColgp_Array1OfVec,
        tabV2d: OCP.TColgp.TColgp_Array1OfVec2d,
    ) -> bool:
        """
    ...
    @overload
    def Tangency(
        self, MPointIndex: int, tabV: OCP.TColgp.TColgp_Array1OfVec
    ) -> bool: ...
    @overload
    def Tangency(
        self, MPointIndex: int, tabV2d: OCP.TColgp.TColgp_Array1OfVec2d
    ) -> bool: ...
    @overload
    ...
    @overload
    def Value(
        self, MPointIndex: int, tabPt2d: OCP.TColgp.TColgp_Array1OfPnt2d
    ) -> None: ...
    @overload
    def Value(
        self,
        MPointIndex: int,
        tabPt: OCP.TColgp.TColgp_Array1OfPnt,
        tabPt2d: OCP.TColgp.TColgp_Array1OfPnt2d,
    ) -> None: ...
...
class BRepApprox_TheZerImpFuncOfTheImpPrmSvSurfacesOfApprox(
    ...
    @overload
    def __init__(
        self, PS: OCP.BRepAdaptor.BRepAdaptor_Surface, IS: OCP.IntSurf.IntSurf_Quadric
    ) -> None: ...
    @overload
