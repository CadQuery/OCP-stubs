...
class BOPTools_AlgoTools:
    ...
    @staticmethod
    def AreFacesSameDomain_s(
        theF1: OCP.TopoDS.TopoDS_Face,
        theF2: OCP.TopoDS.TopoDS_Face,
        theContext: OCP.IntTools.IntTools_Context,
        theFuzz: float = 1e-07,
    ) -> bool:
        """
        ...
        """
    @staticmethod
    def ComputeStateByOnePoint_s(
        theShape: OCP.TopoDS.TopoDS_Shape,
        theSolid: OCP.TopoDS.TopoDS_Solid,
        theTol: float,
        theContext: OCP.IntTools.IntTools_Context,
    ) -> OCP.TopAbs.TopAbs_State:
        """
    ...
    @overload
    def ComputeState_s(
        theVertex: OCP.TopoDS.TopoDS_Vertex,
        theSolid: OCP.TopoDS.TopoDS_Solid,
        theTol: float,
        theContext: OCP.IntTools.IntTools_Context,
    ) -> OCP.TopAbs.TopAbs_State: ...
    ...
    def ComputeState_s(
        ...
        theSolid: OCP.TopoDS.TopoDS_Solid,
        theTol: float,
        theBounds: OCP.TopTools.TopTools_IndexedMapOfShape,
        theContext: OCP.IntTools.IntTools_Context,
    ) -> OCP.TopAbs.TopAbs_State: ...
    @staticmethod
    def ComputeTolerance_s(
        theFace: OCP.TopoDS.TopoDS_Face,
        theEdge: OCP.TopoDS.TopoDS_Edge,
        theMaxDist: float,
        theMaxPar: float,
    ...
    @overload
    def ComputeVV_s(
        theV1: OCP.TopoDS.TopoDS_Vertex,
        theV2: OCP.TopoDS.TopoDS_Vertex,
        theFuzz: float = 1e-07,
    ) -> int:
        """
    ...
    @overload
    def ComputeVV_s(
        theV: OCP.TopoDS.TopoDS_Vertex, theP: OCP.gp.gp_Pnt, theTolP: float
    ) -> int: ...
    @staticmethod
    def CopyEdge_s(theEdge: OCP.TopoDS.TopoDS_Edge) -> OCP.TopoDS.TopoDS_Edge:
        ...
        """
    @staticmethod
    def CorrectCurveOnSurface_s(
        theS: OCP.TopoDS.TopoDS_Shape,
        theMapToAvoid: OCP.TopTools.TopTools_IndexedMapOfShape,
        theTolMax: float = 0.0001,
    ...
    @overload
    def CorrectRange_s(
        aE: OCP.TopoDS.TopoDS_Edge,
        aF: OCP.TopoDS.TopoDS_Face,
        aSR: OCP.IntTools.IntTools_Range,
        aNewSR: OCP.IntTools.IntTools_Range,
    ) -> None:
        """
    ...
    @overload
    def CorrectRange_s(
        aE1: OCP.TopoDS.TopoDS_Edge,
        aE2: OCP.TopoDS.TopoDS_Edge,
        aSR: OCP.IntTools.IntTools_Range,
        aNewSR: OCP.IntTools.IntTools_Range,
    ) -> None: ...
    @staticmethod
    def CorrectShapeTolerances_s(
        theS: OCP.TopoDS.TopoDS_Shape,
        theMapToAvoid: OCP.TopTools.TopTools_IndexedMapOfShape,
        theRunParallel: bool = False,
    ) -> None:
    ...
    def GetEdgeOff_s(
        theEdge: OCP.TopoDS.TopoDS_Edge,
        theFace: OCP.TopoDS.TopoDS_Face,
        theEdgeOff: OCP.TopoDS.TopoDS_Edge,
    ) -> bool:
        """
    ...
    def GetEdgeOnFace_s(
        theEdge: OCP.TopoDS.TopoDS_Edge,
        theFace: OCP.TopoDS.TopoDS_Face,
        theEdgeOnF: OCP.TopoDS.TopoDS_Edge,
    ) -> bool:
        """
    ...
    def GetFaceOff_s(
        ...
        theFaceOff: OCP.TopoDS.TopoDS_Face,
        theContext: OCP.IntTools.IntTools_Context,
    ) -> bool:
        """
        ...
        """
    @staticmethod
    def IsBlockInOnFace_s(
        aShR: OCP.IntTools.IntTools_Range,
        aF: OCP.TopoDS.TopoDS_Face,
        aE: OCP.TopoDS.TopoDS_Edge,
        aContext: OCP.IntTools.IntTools_Context,
    ) -> bool:
        """
    ...
    @staticmethod
    @overload
    def IsInternalFace_s(
        theFace: OCP.TopoDS.TopoDS_Face,
        theSolid: OCP.TopoDS.TopoDS_Solid,
        theMEF: OCP.TopTools.TopTools_IndexedDataMapOfShapeListOfShape,
        theTol: float,
        theContext: OCP.IntTools.IntTools_Context,
    ) -> bool:
        """
    ...
    def IsInternalFace_s(
        theFace: OCP.TopoDS.TopoDS_Face,
        theEdge: OCP.TopoDS.TopoDS_Edge,
        theLF: OCP.TopTools.TopTools_ListOfShape,
        theContext: OCP.IntTools.IntTools_Context,
    ) -> int: ...
    @staticmethod
    ...
    def IsOpenShell_s(theShell: OCP.TopoDS.TopoDS_Shell) -> bool:
        ...
        """
    @staticmethod
    def IsSplitToReverseWithWarn_s(
        theSplit: OCP.TopoDS.TopoDS_Shape,
        theShape: OCP.TopoDS.TopoDS_Shape,
        theContext: OCP.IntTools.IntTools_Context,
        theReport: OCP.Message.Message_Report = None,
    ) -> bool:
        """
    ...
    @staticmethod
    @overload
    def IsSplitToReverse_s(
        theSplit: OCP.TopoDS.TopoDS_Edge,
        theShape: OCP.TopoDS.TopoDS_Edge,
        theContext: OCP.IntTools.IntTools_Context,
        theError: int = None,
    ) -> bool:
        """
    ...
    @overload
    def IsSplitToReverse_s(
        theSplit: OCP.TopoDS.TopoDS_Face,
        theShape: OCP.TopoDS.TopoDS_Face,
        theContext: OCP.IntTools.IntTools_Context,
        theError: int = None,
    ) -> bool: ...
    @staticmethod
    ...
    @staticmethod
    def MakeConnexityBlock_s(
        theLS: OCP.TopTools.TopTools_ListOfShape,
        theMapAvoid: OCP.TopTools.TopTools_IndexedMapOfShape,
        theLSCB: OCP.TopTools.TopTools_ListOfShape,
        theAllocator: OCP.NCollection.NCollection_BaseAllocator,
    ) -> None:
        """
    ...
    @staticmethod
    @overload
    def MakeConnexityBlocks_s(
        theLS: OCP.TopTools.TopTools_ListOfShape,
        theConnectionType: OCP.TopAbs.TopAbs_ShapeEnum,
        theElementType: OCP.TopAbs.TopAbs_ShapeEnum,
    ...
    def MakeConnexityBlocks_s(
        ...
        theConnectionType: OCP.TopAbs.TopAbs_ShapeEnum,
        theElementType: OCP.TopAbs.TopAbs_ShapeEnum,
        theLCB: OCP.TopTools.TopTools_ListOfShape,
    ) -> None: ...
    @staticmethod
    @overload
    def MakeConnexityBlocks_s(
        ...
        theConnectionType: OCP.TopAbs.TopAbs_ShapeEnum,
        theElementType: OCP.TopAbs.TopAbs_ShapeEnum,
        theLCB: OCP.TopTools.TopTools_ListOfListOfShape,
        theConnectionMap: OCP.TopTools.TopTools_IndexedDataMapOfShapeListOfShape,
    ) -> None: ...
    @staticmethod
    def MakeContainer_s(
        theType: OCP.TopAbs.TopAbs_ShapeEnum, theShape: OCP.TopoDS.TopoDS_Shape
    ) -> None:
        """
    ...
    @staticmethod
    def MakeEdge_s(
        theCurve: OCP.IntTools.IntTools_Curve,
        theV1: OCP.TopoDS.TopoDS_Vertex,
        theT1: float,
        theV2: OCP.TopoDS.TopoDS_Vertex,
        theT2: float,
    ...
    def MakeNewVertex_s(
        aE1: OCP.TopoDS.TopoDS_Edge,
        aP1: float,
        aF2: OCP.TopoDS.TopoDS_Face,
        aNewVertex: OCP.TopoDS.TopoDS_Vertex,
    ) -> None:
        """
    ...
    @overload
    def MakeNewVertex_s(
        aP1: OCP.gp.gp_Pnt, aTol: float, aNewVertex: OCP.TopoDS.TopoDS_Vertex
    ) -> None: ...
    @staticmethod
    @overload
    def MakeNewVertex_s(
    ...
    @overload
    def MakeNewVertex_s(
        aV1: OCP.TopoDS.TopoDS_Vertex,
        aV2: OCP.TopoDS.TopoDS_Vertex,
        aNewVertex: OCP.TopoDS.TopoDS_Vertex,
    ) -> None: ...
    @staticmethod
    def MakePCurve_s(
        ...
        thePC1: bool,
        thePC2: bool,
        theContext: OCP.IntTools.IntTools_Context = None,
    ) -> None:
        """
    ...
    @staticmethod
    def MakeSectEdge_s(
        aIC: OCP.IntTools.IntTools_Curve,
        aV1: OCP.TopoDS.TopoDS_Vertex,
        aP1: float,
        aV2: OCP.TopoDS.TopoDS_Vertex,
        aP2: float,
        aNewEdge: OCP.TopoDS.TopoDS_Edge,
    ) -> None:
        """
    ...
    @staticmethod
    def MakeVertex_s(
        theLV: OCP.TopTools.TopTools_ListOfShape, theV: OCP.TopoDS.TopoDS_Vertex
    ) -> None:
        """
    ...
    @staticmethod
    def PointOnEdge_s(
        aEdge: OCP.TopoDS.TopoDS_Edge, aPrm: float, aP: OCP.gp.gp_Pnt
    ) -> None:
        """
    ...
    @overload
    def UpdateVertex_s(
        aIC: OCP.IntTools.IntTools_Curve, aT: float, aV: OCP.TopoDS.TopoDS_Vertex
    ) -> None:
        """
    ...
    @overload
    def UpdateVertex_s(
        aVF: OCP.TopoDS.TopoDS_Vertex, aVN: OCP.TopoDS.TopoDS_Vertex
    ) -> None: ...
    @staticmethod
    @overload
    def UpdateVertex_s(
        aE: OCP.TopoDS.TopoDS_Edge, aT: float, aV: OCP.TopoDS.TopoDS_Vertex
    ) -> None: ...
...
class BOPTools_AlgoTools2D:
    ...
    @staticmethod
    @overload
    def AdjustPCurveOnFace_s(
        theF: OCP.TopoDS.TopoDS_Face,
        theFirst: float,
        theLast: float,
        theC2D: OCP.Geom2d.Geom2d_Curve,
        theC2DA: OCP.Geom2d.Geom2d_Curve,
        theContext: OCP.IntTools.IntTools_Context = None,
    ) -> None:
        """
    ...
    def AdjustPCurveOnFace_s(
        theF: OCP.TopoDS.TopoDS_Face,
        theC3D: OCP.Geom.Geom_Curve,
        theC2D: OCP.Geom2d.Geom2d_Curve,
        theC2DA: OCP.Geom2d.Geom2d_Curve,
        theContext: OCP.IntTools.IntTools_Context = None,
    ) -> None: ...
    @staticmethod
    def AdjustPCurveOnSurf_s(
        aF: OCP.BRepAdaptor.BRepAdaptor_Surface,
        aT1: float,
        aT2: float,
        aC2D: OCP.Geom2d.Geom2d_Curve,
        aC2DA: OCP.Geom2d.Geom2d_Curve,
    ) -> None:
        """
        Adjust P-Curve <aC2D> (3D-curve <C3D>) on surface <aF> . [aT1, aT2] - range to adjust
        """
    @staticmethod
    def AttachExistingPCurve_s(
        aEold: OCP.TopoDS.TopoDS_Edge,
        aEnew: OCP.TopoDS.TopoDS_Edge,
        aF: OCP.TopoDS.TopoDS_Face,
        aCtx: OCP.IntTools.IntTools_Context,
    ) -> int:
        """
        Attach P-Curve from the edge <aEold> on surface <aF> to the edge <aEnew> Returns 0 in case of success
        """
    @staticmethod
    def BuildPCurveForEdgeOnFace_s(
        aE: OCP.TopoDS.TopoDS_Edge,
        aF: OCP.TopoDS.TopoDS_Face,
        theContext: OCP.IntTools.IntTools_Context = None,
    ) -> None:
    ...
    @staticmethod
    @overload
    def CurveOnSurface_s(
        aE: OCP.TopoDS.TopoDS_Edge,
        aF: OCP.TopoDS.TopoDS_Face,
        aC: OCP.Geom2d.Geom2d_Curve,
        theContext: OCP.IntTools.IntTools_Context = None,
    ) -> Tuple[float]:
        """
    ...
    @staticmethod
    def EdgeTangent_s(
        anE: OCP.TopoDS.TopoDS_Edge, aT: float, Tau: OCP.gp.gp_Vec
    ) -> bool:
        """
    ...
    @overload
    def HasCurveOnSurface_s(
        aE: OCP.TopoDS.TopoDS_Edge, aF: OCP.TopoDS.TopoDS_Face
    ) -> bool: ...
    @staticmethod
    @overload
...
class BOPTools_AlgoTools3D:
    ...
    @staticmethod
    def DoSplitSEAMOnFace_s(
        aSp: OCP.TopoDS.TopoDS_Edge, aF: OCP.TopoDS.TopoDS_Face
    ) -> None:
        """
    ...
    @staticmethod
    @overload
    def GetApproxNormalToFaceOnEdge_s(
        aE: OCP.TopoDS.TopoDS_Edge,
        aF: OCP.TopoDS.TopoDS_Face,
        aT: float,
        aPx: OCP.gp.gp_Pnt,
    ...
    @staticmethod
    def GetNormalToSurface_s(
        aS: OCP.Geom.Geom_Surface, U: float, V: float, aD: OCP.gp.gp_Dir
    ) -> bool:
        """
    ...
    def MinStepIn2d_s() -> float:
        ...
        """
    @staticmethod
    def OrientEdgeOnFace_s(
        aE: OCP.TopoDS.TopoDS_Edge,
        aF: OCP.TopoDS.TopoDS_Face,
        aER: OCP.TopoDS.TopoDS_Edge,
    ) -> None:
        """
...
class BOPTools_Box2dTreeSelector:
    ...
    def RejectNode(
        self,
        theCMin: OCP.Graphic3d.Graphic3d_Vec2d,
        theCMax: OCP.Graphic3d.Graphic3d_Vec2d,
        theIsInside: bool,
    ) -> bool:
        """
...
class BOPTools_BoxTree:
    ...
    def __init__(
        self, theBuilder: OCP.Select3D.Select3D_BVHBuilder3d = None
    ) -> None: ...
    pass
...
class BOPTools_BoxTreeSelector:
    ...
    def RejectNode(
        self,
        theCMin: OCP.SelectMgr.SelectMgr_Vec3,
        theCMax: OCP.SelectMgr.SelectMgr_Vec3,
        theIsInside: bool,
    ) -> bool:
        """
        Checks if the box should be rejected
...
class BOPTools_IndexedDataMapOfSetShape(OCP.NCollection.NCollection_BaseMap):
    ...
    def Allocator(self) -> OCP.NCollection.NCollection_BaseAllocator:
        ...
        """
    def Assign(
        self, theOther: BOPTools_IndexedDataMapOfSetShape
    ) -> BOPTools_IndexedDataMapOfSetShape:
        """
    ...
    @overload
    def FindFromKey(
        self, theKey1: BOPTools_Set, theValue: OCP.TopoDS.TopoDS_Shape
    ) -> bool:
        """
        FindFromKey
    ...
    def Statistics(self, S: Any) -> None:
        ...
        """
    def Substitute(
        self, theIndex: int, theKey1: BOPTools_Set, theItem: OCP.TopoDS.TopoDS_Shape
    ) -> None:
        """
        Substitute
        """
...
class BOPTools_ListOfConnexityBlock(OCP.NCollection.NCollection_BaseList):
    ...
    def Assign(
        self, theOther: BOPTools_ListOfConnexityBlock
    ) -> BOPTools_ListOfConnexityBlock:
        """
    ...
    @overload
    def InsertAfter(
        self, theOther: BOPTools_ListOfConnexityBlock, theIter: Any
    ) -> None:
        """
        InsertAfter
    ...
    @overload
    def InsertAfter(
        self, theItem: BOPTools_ConnexityBlock, theIter: Any
    ) -> BOPTools_ConnexityBlock: ...
    @overload
    def InsertBefore(
        self, theOther: BOPTools_ListOfConnexityBlock, theIter: Any
...
class BOPTools_ListOfCoupleOfShape(OCP.NCollection.NCollection_BaseList):
    ...
    def Assign(
        self, theOther: BOPTools_ListOfCoupleOfShape
    ) -> BOPTools_ListOfCoupleOfShape:
        """
        Replace this list by the items of another list (theOther parameter). This method does not change the internal allocator.
        """
    ...
    @overload
    def InsertAfter(
        self, theItem: BOPTools_CoupleOfShape, theIter: Any
    ) -> BOPTools_CoupleOfShape: ...
    @overload
    def InsertBefore(
        self, theOther: BOPTools_ListOfCoupleOfShape, theIter: Any
    ) -> None:
        """
        InsertBefore
...
class BOPTools_MapOfSet(OCP.NCollection.NCollection_BaseMap):
    ...
    def Differ(self, theOther: BOPTools_MapOfSet) -> bool:
        ...
        """
    def Difference(
        self, theLeft: BOPTools_MapOfSet, theRight: BOPTools_MapOfSet
    ) -> None:
        """
...
class BOPTools_Set:
    ...
    def Add(
        self, theS: OCP.TopoDS.TopoDS_Shape, theType: OCP.TopAbs.TopAbs_ShapeEnum
    ) -> None:
        """
        None
        """
