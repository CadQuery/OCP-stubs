...
class BRepOffset:
    ...
    @staticmethod
    def CollapseSingularities_s(
        theSurface: OCP.Geom.Geom_Surface,
        theFace: OCP.TopoDS.TopoDS_Face,
        thePrecision: float,
    ) -> OCP.Geom.Geom_Surface:
        """
...
class BRepOffset_Analyse:
    ...
    def AddFaces(
        ...
        Co: OCP.TopoDS.TopoDS_Compound,
        Map: OCP.TopTools.TopTools_MapOfShape,
    ...
    def Ancestors(
        self, S: OCP.TopoDS.TopoDS_Shape
    ...
    def Edges(
        ...
        T: BRepOffset_Type,
        L: OCP.TopTools.TopTools_ListOfShape,
    ) -> None:
        """
    ...
    @overload
    def Explode(
        self, L: OCP.TopTools.TopTools_ListOfShape, Type: BRepOffset_Type
    ) -> None: ...
    ...
    def TangentEdges(
        self,
        Edge: OCP.TopoDS.TopoDS_Edge,
        Vertex: OCP.TopoDS.TopoDS_Vertex,
        Edges: OCP.TopTools.TopTools_ListOfShape,
    ) -> None:
        """
...
class BRepOffset_DataMapOfShapeListOfInterval(OCP.NCollection.NCollection_BaseMap):
    ...
    def Allocator(self) -> OCP.NCollection.NCollection_BaseAllocator:
        ...
        """
    def Assign(
        self, theOther: BRepOffset_DataMapOfShapeListOfInterval
    ) -> BRepOffset_DataMapOfShapeListOfInterval:
        """
        Assignment. This method does not change the internal allocator.
        """
    def Bind(
        self, theKey: OCP.TopoDS.TopoDS_Shape, theItem: BRepOffset_ListOfInterval
    ) -> bool:
        """
    ...
    @overload
    def Find(
        self, theKey: OCP.TopoDS.TopoDS_Shape, theValue: BRepOffset_ListOfInterval
    ) -> bool:
        """
...
class BRepOffset_DataMapOfShapeMapOfShape(OCP.NCollection.NCollection_BaseMap):
    ...
    def Allocator(self) -> OCP.NCollection.NCollection_BaseAllocator:
        ...
        """
    def Assign(
        self, theOther: BRepOffset_DataMapOfShapeMapOfShape
    ) -> BRepOffset_DataMapOfShapeMapOfShape:
        """
        Assignment. This method does not change the internal allocator.
        """
    def Bind(
        self, theKey: OCP.TopoDS.TopoDS_Shape, theItem: OCP.TopTools.TopTools_MapOfShape
    ) -> bool:
        """
        Bind binds Item to Key in map.
        """
    def Bound(
        self, theKey: OCP.TopoDS.TopoDS_Shape, theItem: OCP.TopTools.TopTools_MapOfShape
    ) -> OCP.TopTools.TopTools_MapOfShape:
        """
        Bound binds Item to Key in map. Returns modifiable Item
        """
    def ChangeFind(
        self, theKey: OCP.TopoDS.TopoDS_Shape
    ) -> OCP.TopTools.TopTools_MapOfShape:
        """
        ChangeFind returns mofifiable Item by Key. Raises if Key was not bound
        """
    ...
    def Find(
        self,
        theKey: OCP.TopoDS.TopoDS_Shape,
        theValue: OCP.TopTools.TopTools_MapOfShape,
    ) -> bool: ...
    def IsBound(self, theKey: OCP.TopoDS.TopoDS_Shape) -> bool:
        """
        IsBound
...
class BRepOffset_DataMapOfShapeOffset(OCP.NCollection.NCollection_BaseMap):
    ...
    def Allocator(self) -> OCP.NCollection.NCollection_BaseAllocator:
        ...
        """
    def Assign(
        self, theOther: BRepOffset_DataMapOfShapeOffset
    ) -> BRepOffset_DataMapOfShapeOffset:
        """
        Assignment. This method does not change the internal allocator.
        """
    def Bind(self, theKey: OCP.TopoDS.TopoDS_Shape, theItem: BRepOffset_Offset) -> bool:
        ...
        """
    def Bound(
        self, theKey: OCP.TopoDS.TopoDS_Shape, theItem: BRepOffset_Offset
    ) -> BRepOffset_Offset:
        """
        Bound binds Item to Key in map. Returns modifiable Item
        """
    ...
    @overload
    def Find(
        self, theKey: OCP.TopoDS.TopoDS_Shape, theValue: BRepOffset_Offset
    ) -> bool: ...
    def IsBound(self, theKey: OCP.TopoDS.TopoDS_Shape) -> bool:
        """
        IsBound
...
class BRepOffset_Inter2d:
    ...
    @staticmethod
    def Compute_s(
        AsDes: OCP.BRepAlgo.BRepAlgo_AsDes,
        F: OCP.TopoDS.TopoDS_Face,
        NewEdges: OCP.TopTools.TopTools_IndexedMapOfShape,
        Tol: float,
        theDMVV: OCP.TopTools.TopTools_IndexedDataMapOfShapeListOfShape,
    ) -> None:
        """
    ...
    def ConnexIntByIntInVert_s(
        FI: OCP.TopoDS.TopoDS_Face,
        OFI: BRepOffset_Offset,
        MES: OCP.TopTools.TopTools_DataMapOfShapeShape,
        Build: OCP.TopTools.TopTools_DataMapOfShapeShape,
        AsDes: OCP.BRepAlgo.BRepAlgo_AsDes,
        AsDes2d: OCP.BRepAlgo.BRepAlgo_AsDes,
        Tol: float,
        theDMVV: OCP.TopTools.TopTools_IndexedDataMapOfShapeListOfShape,
    ) -> None:
        """
    ...
    def ConnexIntByInt_s(
        ...
        Offset: float,
        Tol: float,
        FacesWithVerts: OCP.TopTools.TopTools_IndexedMapOfShape,
        theDMVV: OCP.TopTools.TopTools_IndexedDataMapOfShapeListOfShape,
    ) -> None:
        """
    ...
    def FuseVertices_s(
        theDMVV: OCP.TopTools.TopTools_IndexedDataMapOfShapeListOfShape,
        theAsDes: OCP.BRepAlgo.BRepAlgo_AsDes,
    ) -> None:
        """
...
class BRepOffset_Inter3d:
    ...
    def CompletInt(
        self,
        SetOfFaces: OCP.TopTools.TopTools_ListOfShape,
        InitOffsetFace: OCP.BRepAlgo.BRepAlgo_Image,
    ) -> None:
        """
        None
        """
    def ConnexIntByArc(
        self,
        SetOfFaces: OCP.TopTools.TopTools_ListOfShape,
        ShapeInit: OCP.TopoDS.TopoDS_Shape,
    ...
    def ConnexIntByInt(
        self,
        SI: OCP.TopoDS.TopoDS_Shape,
        MapSF: BRepOffset_DataMapOfShapeOffset,
        A: BRepOffset_Analyse,
        MES: OCP.TopTools.TopTools_DataMapOfShapeShape,
        Build: OCP.TopTools.TopTools_DataMapOfShapeShape,
        Failed: OCP.TopTools.TopTools_ListOfShape,
        bIsPlanar: bool = False,
    ) -> None:
        """
        None
        """
    def ContextIntByArc(
        self,
        ContextFaces: OCP.TopTools.TopTools_IndexedMapOfShape,
        ExtentContext: bool,
        Analyse: BRepOffset_Analyse,
        InitOffsetFace: OCP.BRepAlgo.BRepAlgo_Image,
        InitOffsetEdge: OCP.BRepAlgo.BRepAlgo_Image,
    ) -> None:
        """
        None
        """
...
class BRepOffset_ListOfInterval(OCP.NCollection.NCollection_BaseList):
    ...
    def Assign(self, theOther: BRepOffset_ListOfInterval) -> BRepOffset_ListOfInterval:
        ...
        """
    def Clear(
        self, theAllocator: OCP.NCollection.NCollection_BaseAllocator = None
    ) -> None:
        """
        Clear this list
        """
    ...
    @overload
    def InsertAfter(
        self, theItem: BRepOffset_Interval, theIter: Any
    ) -> BRepOffset_Interval:
        """
        InsertAfter
    ...
    @overload
    def InsertAfter(
        self, theOther: BRepOffset_ListOfInterval, theIter: Any
    ) -> None: ...
    @overload
    def InsertBefore(
        self, theItem: BRepOffset_Interval, theIter: Any
...
class BRepOffset_MakeLoops:
    ...
    def Build(
        ...
        AsDes: OCP.BRepAlgo.BRepAlgo_AsDes,
        Image: OCP.BRepAlgo.BRepAlgo_Image,
    ) -> None:
        """
        None
        """
    ...
    def BuildOnContext(
        self,
        LContext: OCP.TopTools.TopTools_ListOfShape,
        Analyse: BRepOffset_Analyse,
        AsDes: OCP.BRepAlgo.BRepAlgo_AsDes,
        Image: OCP.BRepAlgo.BRepAlgo_Image,
        InSide: bool,
...
class BRepOffset_MakeOffset:
    ...
    def Initialize(
        ...
        Offset: float,
        Tol: float,
        Mode: BRepOffset_Mode = BRepOffset_Mode.BRepOffset_Skin,
        Intersection: bool = False,
        SelfInter: bool = False,
        Join: OCP.GeomAbs.GeomAbs_JoinType = GeomAbs_JoinType.GeomAbs_Arc,
...
class BRepOffset_MakeSimpleOffset:
    ...
    def GetTolerance(self) -> float:
        ...
        """
    def Initialize(
        self, theInputShape: OCP.TopoDS.TopoDS_Shape, theOffsetValue: float
    ) -> None:
        """
...
class BRepOffset_Offset:
    ...
    def Init(
        self,
        Vertex: OCP.TopoDS.TopoDS_Vertex,
        LEdge: OCP.TopTools.TopTools_ListOfShape,
        Offset: float,
        Polynomial: bool = False,
        Tol: float = 0.0001,
        Conti: OCP.GeomAbs.GeomAbs_Shape = GeomAbs_Shape.GeomAbs_C1,
    ) -> None:
        """
        None
    ...
    def Init(
        self,
        Path: OCP.TopoDS.TopoDS_Edge,
        Edge1: OCP.TopoDS.TopoDS_Edge,
        Edge2: OCP.TopoDS.TopoDS_Edge,
        Offset: float,
        FirstEdge: OCP.TopoDS.TopoDS_Edge,
        LastEdge: OCP.TopoDS.TopoDS_Edge,
        Polynomial: bool = False,
        Tol: float = 0.0001,
        Conti: OCP.GeomAbs.GeomAbs_Shape = GeomAbs_Shape.GeomAbs_C1,
    ) -> None: ...
    ...
    def Init(
        ...
        JoinType: OCP.GeomAbs.GeomAbs_JoinType = GeomAbs_JoinType.GeomAbs_Arc,
    ) -> None: ...
    @overload
    def Init(
        self,
        Face: OCP.TopoDS.TopoDS_Face,
        Offset: float,
        Created: OCP.TopTools.TopTools_DataMapOfShapeShape,
        OffsetOutside: bool = True,
        JoinType: OCP.GeomAbs.GeomAbs_JoinType = GeomAbs_JoinType.GeomAbs_Arc,
    ) -> None: ...
    @overload
...
class BRepOffset_SimpleOffset(
    OCP.BRepTools.BRepTools_Modification, OCP.Standard.Standard_Transient
):
    """
    ...
    def Continuity(
        ...
        F1: OCP.TopoDS.TopoDS_Face,
        F2: OCP.TopoDS.TopoDS_Face,
        NewE: OCP.TopoDS.TopoDS_Edge,
        NewF1: OCP.TopoDS.TopoDS_Face,
        NewF2: OCP.TopoDS.TopoDS_Face,
    ...
    def NewParameter(
        ...
        """
    def NewPoint(
        self, V: OCP.TopoDS.TopoDS_Vertex, P: OCP.gp.gp_Pnt, Tol: float
    ) -> bool:
        """
    ...
    def NewPolygonOnTriangulation(
        ...
        E: OCP.TopoDS.TopoDS_Edge,
        F: OCP.TopoDS.TopoDS_Face,
        P: OCP.Poly.Poly_PolygonOnTriangulation,
    ) -> bool:
        """
    ...
    def NewTriangulation(
        self, F: OCP.TopoDS.TopoDS_Face, T: OCP.Poly.Poly_Triangulation
    ) -> bool:
        """
    ...
    def __init__(
        self,
        theInputShape: OCP.TopoDS.TopoDS_Shape,
...
class BRepOffset_Tool:
    ...
    @staticmethod
    def BuildNeighbour_s(
        W: OCP.TopoDS.TopoDS_Wire,
        F: OCP.TopoDS.TopoDS_Face,
        NOnV1: OCP.TopTools.TopTools_DataMapOfShapeShape,
        NOnV2: OCP.TopTools.TopTools_DataMapOfShapeShape,
    ) -> None:
        """
    ...
    @staticmethod
    def CheckBounds_s(
        F: OCP.TopoDS.TopoDS_Face, Analyse: BRepOffset_Analyse
    ) -> Tuple[bool, bool, bool]:
        """
        None
        """
    @staticmethod
    def CheckPlanesNormals_s(
        theFace1: OCP.TopoDS.TopoDS_Face,
        theFace2: OCP.TopoDS.TopoDS_Face,
        theTolAng: float = 1e-08,
    ) -> bool:
        """
        ...
        """
    @staticmethod
    def CorrectOrientation_s(
        SI: OCP.TopoDS.TopoDS_Shape,
        NewEdges: OCP.TopTools.TopTools_IndexedMapOfShape,
        AsDes: OCP.BRepAlgo.BRepAlgo_AsDes,
        InitOffset: OCP.BRepAlgo.BRepAlgo_Image,
        Offset: float,
    ) -> None:
        """
        None
    ...
    @staticmethod
    def Deboucle3D_s(
        S: OCP.TopoDS.TopoDS_Shape, Boundary: OCP.TopTools.TopTools_MapOfShape
    ...
    def EnLargeFace_s(
        F: OCP.TopoDS.TopoDS_Face,
        NF: OCP.TopoDS.TopoDS_Face,
        ChangeGeom: bool,
        UpDatePCurve: bool = False,
        enlargeU: bool = True,
        enlargeVfirst: bool = True,
        enlargeVlast: bool = True,
        theExtensionMode: int = 1,
        theLenBeforeUfirst: float = -1.0,
        theLenAfterUlast: float = -1.0,
        theLenBeforeVfirst: float = -1.0,
        theLenAfterVlast: float = -1.0,
    ) -> bool:
        """
    ...
    def ExtentFace_s(
        F: OCP.TopoDS.TopoDS_Face,
        ConstShapes: OCP.TopTools.TopTools_DataMapOfShapeShape,
        ToBuild: OCP.TopTools.TopTools_DataMapOfShapeShape,
        Side: OCP.TopAbs.TopAbs_State,
        TolConf: float,
        NF: OCP.TopoDS.TopoDS_Face,
    ) -> None:
    ...
    @staticmethod
    @overload
    def FindCommonShapes_s(
        theS1: OCP.TopoDS.TopoDS_Shape,
        theS2: OCP.TopoDS.TopoDS_Shape,
        theType: OCP.TopAbs.TopAbs_ShapeEnum,
        theLSC: OCP.TopTools.TopTools_ListOfShape,
    ) -> bool:
        """
    ...
    @overload
    def FindCommonShapes_s(
        theF1: OCP.TopoDS.TopoDS_Face,
        theF2: OCP.TopoDS.TopoDS_Face,
        theLE: OCP.TopTools.TopTools_ListOfShape,
        theLV: OCP.TopTools.TopTools_ListOfShape,
    ) -> bool: ...
    @staticmethod
    ...
    def Inter2d_s(
        ...
        LV: OCP.TopTools.TopTools_ListOfShape,
        Tol: float,
    ) -> None:
        """
        None
    ...
    def Inter3D_s(
        F1: OCP.TopoDS.TopoDS_Face,
        F2: OCP.TopoDS.TopoDS_Face,
        LInt1: OCP.TopTools.TopTools_ListOfShape,
        LInt2: OCP.TopTools.TopTools_ListOfShape,
        Side: OCP.TopAbs.TopAbs_State,
        RefEdge: OCP.TopoDS.TopoDS_Edge,
        IsRefEdgeDefined: bool = False,
    ) -> None:
        """
    ...
    def InterOrExtent_s(
        ...
        """
    @staticmethod
    def MapVertexEdges_s(
        S: OCP.TopoDS.TopoDS_Shape, MVE: OCP.TopTools.TopTools_DataMapOfShapeListOfShape
    ) -> None:
        """
    ...
    @staticmethod
    def OriEdgeInFace_s(
        E: OCP.TopoDS.TopoDS_Edge, F: OCP.TopoDS.TopoDS_Face
    ...
    def OrientSection_s(
        ...
        F1: OCP.TopoDS.TopoDS_Face,
        F2: OCP.TopoDS.TopoDS_Face,
        O1: OCP.TopAbs.TopAbs_Orientation,
        O2: OCP.TopAbs.TopAbs_Orientation,
    ) -> None:
        """
