...
class Resource_FormatType():
    ...
    def name(self) -> str:
        ...
        :type: str
        """
    Resource_ANSI: OCP.Resource.Resource_FormatType # value = Resource_FormatType.Resource_FormatType_ANSI
    Resource_EUC: OCP.Resource.Resource_FormatType # value = Resource_FormatType.Resource_FormatType_EUC
    Resource_FormatType_ANSI: OCP.Resource.Resource_FormatType # value = Resource_FormatType.Resource_FormatType_ANSI
    Resource_FormatType_EUC: OCP.Resource.Resource_FormatType # value = Resource_FormatType.Resource_FormatType_EUC
    Resource_FormatType_GB: OCP.Resource.Resource_FormatType # value = Resource_FormatType.Resource_FormatType_GB
    Resource_FormatType_SJIS: OCP.Resource.Resource_FormatType # value = Resource_FormatType.Resource_FormatType_SJIS
    Resource_FormatType_SystemLocale: OCP.Resource.Resource_FormatType # value = Resource_FormatType.Resource_FormatType_SystemLocale
    Resource_FormatType_UTF8: OCP.Resource.Resource_FormatType # value = Resource_FormatType.Resource_FormatType_UTF8
    Resource_GB: OCP.Resource.Resource_FormatType # value = Resource_FormatType.Resource_FormatType_GB
    Resource_SJIS: OCP.Resource.Resource_FormatType # value = Resource_FormatType.Resource_FormatType_SJIS
    __entries: dict # value = {'Resource_FormatType_SJIS': (Resource_FormatType.Resource_FormatType_SJIS, None), 'Resource_FormatType_EUC': (Resource_FormatType.Resource_FormatType_EUC, None), 'Resource_FormatType_ANSI': (Resource_FormatType.Resource_FormatType_ANSI, None), 'Resource_FormatType_GB': (Resource_FormatType.Resource_FormatType_GB, None), 'Resource_FormatType_UTF8': (Resource_FormatType.Resource_FormatType_UTF8, None), 'Resource_FormatType_SystemLocale': (Resource_FormatType.Resource_FormatType_SystemLocale, None), 'Resource_SJIS': (Resource_FormatType.Resource_FormatType_SJIS, None), 'Resource_EUC': (Resource_FormatType.Resource_FormatType_EUC, None), 'Resource_ANSI': (Resource_FormatType.Resource_FormatType_ANSI, None), 'Resource_GB': (Resource_FormatType.Resource_FormatType_GB, None)}
    __members__: dict # value = {'Resource_FormatType_SJIS': Resource_FormatType.Resource_FormatType_SJIS, 'Resource_FormatType_EUC': Resource_FormatType.Resource_FormatType_EUC, 'Resource_FormatType_ANSI': Resource_FormatType.Resource_FormatType_ANSI, 'Resource_FormatType_GB': Resource_FormatType.Resource_FormatType_GB, 'Resource_FormatType_UTF8': Resource_FormatType.Resource_FormatType_UTF8, 'Resource_FormatType_SystemLocale': Resource_FormatType.Resource_FormatType_SystemLocale, 'Resource_SJIS': Resource_FormatType.Resource_FormatType_SJIS, 'Resource_EUC': Resource_FormatType.Resource_FormatType_EUC, 'Resource_ANSI': Resource_FormatType.Resource_FormatType_ANSI, 'Resource_GB': Resource_FormatType.Resource_FormatType_GB}
    pass
...
class Resource_Unicode():
    ...
    """
    @staticmethod
    def ConvertANSIToUnicode_s(fromstr : str,tostr : OCP.TCollection.TCollection_ExtendedString) -> None: 
        """
