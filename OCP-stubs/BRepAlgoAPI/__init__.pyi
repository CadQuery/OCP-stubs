...
class BRepAlgoAPI_BuilderAlgo(
    ...
    def FuzzyValue(self) -> float:
        ...
        """
    def Generated(
        self, theS: OCP.TopoDS.TopoDS_Shape
    ) -> OCP.TopTools.TopTools_ListOfShape:
        """
    ...
    def SimplifyResult(
        self,
        theUnifyEdges: bool = True,
        theUnifyFaces: bool = True,
        theAngularTol: float = 1e-12,
    ) -> None:
        """
...
class BRepAlgoAPI_Check(OCP.BOPAlgo.BOPAlgo_Options):
    ...
    @overload
    def SetData(
        self, theS: OCP.TopoDS.TopoDS_Shape, bTestSE: bool = True, bTestSI: bool = True
    ) -> None:
        """
    ...
    def SetData(
        ...
        theOp: OCP.BOPAlgo.BOPAlgo_Operation = BOPAlgo_Operation.BOPAlgo_UNKNOWN,
        bTestSE: bool = True,
        bTestSI: bool = True,
    ) -> None: ...
    def SetFuzzyValue(self, theFuzz: float) -> None:
    ...
    def SetProgressIndicator(
        self, theObj: OCP.Message.Message_ProgressIndicator
    ) -> None:
        """
...
class BRepAlgoAPI_Common(
    ...
    def __init__(
        ...
        PF: OCP.BOPAlgo.BOPAlgo_PaveFiller,
    ) -> None: ...
    @overload
...
class BRepAlgoAPI_Cut(
    ...
    def __init__(
        ...
        S1: OCP.TopoDS.TopoDS_Shape,
        S2: OCP.TopoDS.TopoDS_Shape,
        aDSF: OCP.BOPAlgo.BOPAlgo_PaveFiller,
        bFWD: bool = True,
    ) -> None: ...
    pass
...
class BRepAlgoAPI_Section(
    ...
    @overload
    def __init__(
        self, S1: OCP.TopoDS.TopoDS_Shape, Pl: OCP.gp.gp_Pln, PerformNow: bool = True
    ) -> None: ...
    @overload
    def __init__(
        self,
