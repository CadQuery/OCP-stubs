...
class BRepAlgo:
    ...
    def ConcatenateWireC0_s(Wire: OCP.TopoDS.TopoDS_Wire) -> OCP.TopoDS.TopoDS_Edge:
        ...
        """
    @staticmethod
    def ConcatenateWire_s(
        Wire: OCP.TopoDS.TopoDS_Wire,
        Option: OCP.GeomAbs.GeomAbs_Shape,
        AngularTolerance: float = 0.0001,
    ...
    @overload
    def IsValid_s(
        theArgs: OCP.TopTools.TopTools_ListOfShape,
        theResult: OCP.TopoDS.TopoDS_Shape,
        closedSolid: bool = False,
        GeomCtrl: bool = True,
    ) -> bool: ...
...
class BRepAlgo_AsDes(OCP.Standard.Standard_Transient):
    ...
    @overload
    def Add(
        self, S: OCP.TopoDS.TopoDS_Shape, SS: OCP.TopTools.TopTools_ListOfShape
    ) -> None: ...
    def Ascendant(
    ...
    def HasCommonDescendant(
        self,
        S1: OCP.TopoDS.TopoDS_Shape,
        S2: OCP.TopoDS.TopoDS_Shape,
        LC: OCP.TopTools.TopTools_ListOfShape,
    ) -> bool:
        """
    ...
    def Remove(self, S: OCP.TopoDS.TopoDS_Shape) -> None:
        ...
        """
    def Replace(
        self, OldS: OCP.TopoDS.TopoDS_Shape, NewS: OCP.TopoDS.TopoDS_Shape
    ) -> None:
        """
...
class BRepAlgo_BooleanOperation(
    ...
    def Modified(self, S: OCP.TopoDS.TopoDS_Shape) -> OCP.TopTools.TopTools_ListOfShape:
        ...
        """
    def Perform(
        self, St1: OCP.TopAbs.TopAbs_State, St2: OCP.TopAbs.TopAbs_State
    ) -> None:
        """
        None
        """
...
class BRepAlgo_Common(
    ...
    def Shape2(self) -> OCP.TopoDS.TopoDS_Shape:
        ...
        """
    def __init__(
        self, S1: OCP.TopoDS.TopoDS_Shape, S2: OCP.TopoDS.TopoDS_Shape
    ) -> None: ...
    pass
...
class BRepAlgo_Image:
    ...
    @overload
    def Add(
        self, OldS: OCP.TopoDS.TopoDS_Shape, NewS: OCP.TopTools.TopTools_ListOfShape
    ) -> None: ...
    @overload
    def Bind(
        self, OldS: OCP.TopoDS.TopoDS_Shape, NewS: OCP.TopoDS.TopoDS_Shape
    ...
    def Compact(self) -> None:
        ...
        """
    def Filter(
        self, S: OCP.TopoDS.TopoDS_Shape, ShapeType: OCP.TopAbs.TopAbs_ShapeEnum
    ) -> None:
        """
    ...
    def IsImage(self, S: OCP.TopoDS.TopoDS_Shape) -> bool:
        ...
        """
    def LastImage(
        self, S: OCP.TopoDS.TopoDS_Shape, L: OCP.TopTools.TopTools_ListOfShape
    ) -> None:
        """
...
class BRepAlgo_Loop:
    ...
    def AddConstEdges(self, LE: OCP.TopTools.TopTools_ListOfShape) -> None:
        ...
        """
    def AddEdge(
        self, E: OCP.TopoDS.TopoDS_Edge, LV: OCP.TopTools.TopTools_ListOfShape
    ) -> None:
        """
    ...
    def CutEdge(
        ...
        VonE: OCP.TopTools.TopTools_ListOfShape,
        NE: OCP.TopTools.TopTools_ListOfShape,
    ) -> None:
        """
        Cut the edge <E> in several edges <NE> on the vertices<VonE>.
        """
    def GetVerticesForSubstitute(
        self, VerVerMap: OCP.TopTools.TopTools_DataMapOfShapeShape
    ) -> None:
        """
...
class BRepAlgo_Section(
    ...
    def HasAncestorFaceOn1(
        self, E: OCP.TopoDS.TopoDS_Shape, F: OCP.TopoDS.TopoDS_Shape
    ) -> bool:
        """
    ...
    def __init__(
        self,
        Sh1: OCP.TopoDS.TopoDS_Shape,
        Sh2: OCP.TopoDS.TopoDS_Shape,
        PerformNow: bool = True,
    ) -> None: ...
    @overload
    def __init__(
        self,
        Sh: OCP.TopoDS.TopoDS_Shape,
        Sf: OCP.Geom.Geom_Surface,
        PerformNow: bool = True,
    ) -> None: ...
    @overload
    def __init__(
        self, Sh: OCP.TopoDS.TopoDS_Shape, Pl: OCP.gp.gp_Pln, PerformNow: bool = True
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    def __init__(
        self,
        Sf1: OCP.Geom.Geom_Surface,
        Sf2: OCP.Geom.Geom_Surface,
        PerformNow: bool = True,
    ) -> None: ...
    pass
