...
class ShapeAnalysis_Edge():
    ...
    @staticmethod
    def ComputeDeviation_s(CRef : OCP.Adaptor3d.Adaptor3d_Curve,Other : OCP.Adaptor3d.Adaptor3d_Curve,SameParameter : bool,dev : float,NCONTROL : int) -> bool: 
        """
...
class ShapeAnalysis_Surface(OCP.Standard.Standard_Transient):
    ...
    """
    def Adaptor3d(self) -> OCP.GeomAdaptor.GeomAdaptor_HSurface: 
        """
    ...
    def This(self) -> OCP.Standard.Standard_Transient: 
        ...
        Returns non-const pointer to this object (like const_cast). For protection against creating handle to objects allocated in stack or call from constructor, it will raise exception Standard_ProgramError if reference counter is zero.
        """
    def TrueAdaptor3d(self) -> OCP.GeomAdaptor.GeomAdaptor_HSurface: 
        """
...
class ShapeAnalysis_WireVertex():
    ...
    def SetEnd(self,num : int,pos : OCP.gp.gp_XYZ,ufol : float) -> None: 
        """
        <num> is the End of preceeding Edge, and its projection on the following one lies on it at the Precision of <me> <ufol> gives the parameter on the following edge
        """
    ...
    def SetStart(self,num : int,pos : OCP.gp.gp_XYZ,upre : float) -> None: 
        """
        <num> is the Start of following Edge, its projection on the preceeding one lies on it at the Precision of <me> <upre> gives the parameter on the preceeding edge
        """
