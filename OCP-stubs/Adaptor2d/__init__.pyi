...
class Adaptor2d_Line2d(Adaptor2d_Curve2d):
    ...
    def D1(self, X: float, P: OCP.gp.gp_Pnt2d, V: OCP.gp.gp_Vec2d) -> None:
        ...
        """
    def D2(
        self, X: float, P: OCP.gp.gp_Pnt2d, V1: OCP.gp.gp_Vec2d, V2: OCP.gp.gp_Vec2d
    ) -> None:
        """
        None
        """
    ...
    @overload
    def __init__(
        self, P: OCP.gp.gp_Pnt2d, D: OCP.gp.gp_Dir2d, UFirst: float, ULast: float
    ) -> None: ...
    @overload
    def __init__(self) -> None: ...
    pass
...
class Adaptor2d_OffsetCurve(Adaptor2d_Curve2d):
    ...
    @overload
    def __init__(
        self, C: Adaptor2d_HCurve2d, Offset: float, WFirst: float, WLast: float
    ) -> None: ...
    @overload
